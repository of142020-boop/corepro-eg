...
export const metadata: Metadata = {
 ...
 // بدون template نهائيًا، عشان ما يضيفش "كور برو - Core Pro" على أي صفحة
 title: "كور برو مصر: قص وتخريم الخرسانة | تركيب شفاطات مطابخ - 01055550195",

 description:
 "شركة كور برو - Core Pro الأولى في قص الخرسانة بالمنشار (ليزر) وتخريم الكور لعمل الفتحات. فني تركيب شفاط المطبخ وتركيب مداخن وشفاطات حمام.",
