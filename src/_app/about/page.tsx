...
export const metadata: Metadata = {
 title: "من نحن - كور برو - Core Pro",
 description:
 "تعرف على شركة كور برو - Core Pro المتخصصة في قص الخرسانة بالمنشار وتخريم الكور وتركيب الشفاطات داخل القاهرة والجيزة.",
};
...
export default function AboutPage() {
 ...
 نحن في <strong>كور برو - Core Pro</strong> شركة متخصصة في
