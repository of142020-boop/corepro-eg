...
export const metadata: Metadata = {
 ...
 description:
 "شركة كور برو - Core Pro الأولى في قص الخرسانة بالمنشار (ليزر) وتخريم الكور لعمل الفتحات. فني تركيب شفاط المطبخ وتركيب مداخن وشفاطات حمام. دقة، أمان، وأفضل سعر.",
...
export default function HomePage() {
 ...
 <Section
 id="why"
 title="لماذا تختار كور برو - Core Pro؟"
 ...
 <span>{item.q}</span>
 <span className="text-slate-500 group-open:rotate-180 transition"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"/></svg></span>
 </summary>
