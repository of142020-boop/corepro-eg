...
const TAGAMOA_AREAS = [
  ...
  'وسط التجمع الخامس والكورنيش',
];

const FAQ = [
  {
    q: 'هل تعملون في التجمع الخامس بشكل دائم وليس موسمياً؟',
    a: 'نعم، لدينا فريق متخصص يغطي التجمع الخامس بشكل كامل ودائم طوال العام. نخدم جميع أحياء التجمع الخامس من المنتزه شرقاً حتى العجمي والدخيلة غرباً ونصل لموقعك في أسرع وقت ممكن.',
  },
  {
  ...
  {
    q: 'هل تعملون في المباني القديمة والكلاسيكية في وسط التجمع الخامس؟',
    a: 'نعم، ولدينا خبرة خاصة في التعامل مع خرسانة المباني القديمة والعمائر الكلاسيكية في التجمع الخامس. نقوم بمعاينة دقيقة لتحديد طبيعة الخرسانة ومستوى التسليح أولاً، مما يضمن تنفيذ العمل بأمان دون المساس بسلامة الهيكل الإنشائي القديم.',
  },
  {
    q: 'هل تؤثر رطوبة وملوحة هواء التجمع الخامس على جودة العمل؟',
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div>
              ...
              <div className="mt-5 text-slate-800 leading-9 space-y-4 text-lg">
                ...
                <p>
                  سواء كنت تحتاج <strong>معلم قص جدار بالتجمع الخامس</strong> لفتح باب أو شباك، أو <strong>صنايعي كور اسكندرية</strong> لتمرير مواسير الغاز والتكييف،
        ...
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-10 min-w-0">
            ...
            <Section id="saw-New Cairo" title="قص الخرسانة بالمنشار في التجمع الخامس">
              ...
              <p>
                كثير من مباني التجمع الخامس القديمة في الأحياء المركزية كالإبراهيمية وسيدي جابر وبحري تحتاج لتوسعة فتحات الأبواب أو فتح مداخل جديدة.
              ...
              <div className="not-prose mt-6 space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    ...
                    { icon: Fan, color: 'text-emerald-500', bg: 'bg-emerald-50', t: 'فتحات الشفاطات والمداخن', d: 'فتحة المدخنة ومسار الدكت بالقطر المناسب للشفاط مع ضمان الإحكام ضد رطوبة هواء التجمع الخامس.' },
                  ].map(x => (
            ...
            <Section id="comparison" title="قص الخرسانة الاحترافي مقابل التكسير التقليدي في التجمع الخامس">
              <p>
                ...
                وهذا قد يُشكّل خطراً حقيقياً على مباني التجمع الخامس القديمة التي تعاني أصلاً من التقادم وتأثير رطوبة البحر على الخرسانة.
                اليك مقارنة موضوعية:
              </p>
            ...
            <Section id="hoods-New Cairo" title="تركيب شفاطات المطابخ والحمامات بالتجمع الخامس">
              ...
              <p>
                نعلم أن رطوبة الجو الساحلي في التجمع الخامس تعني أن <strong>اختيار الشفاط المناسب</strong> له أهمية خاصة.
              ...
              <div className="not-prose grid gap-4 md:grid-cols-3 mt-6">
                {[
                  ...
                  { t: 'شفاطات بفلتر كربوني', d: 'للشقق التي لا يمكن فيها عمل فتحة خارجية — الحل الأنسب لأبراج التجمع الخامس عالية الطوابق.' },
                  { t: 'شفاطات حمام مركزية', d: 'تركيب شبكة دكت مركزية لطرد الرطوبة المتراكمة في الحمامات — ضرورة في مناخ التجمع الخامس الرطب.' },
                ].map(x => (
            ...
            <Section id="wire-New Cairo" title="قص الخرسانة بالواير الماسي في التجمع الخامس — المشاريع الكبرى">
              <p>
                ...
                التي تفوق قدرة المنشار التقليدي — مثل قص كباري كورنيش التجمع الخامس، قواعد الأرصفة البحرية، الأساسات الضخمة، وقواعد الماكينات الصناعية في الدخيلة وبرج العرب.
              </p>
              <p>
                ...
                لا يوجد حد أقصى لسماكة الخرسانة — مما يجعله مثالياً لمشاريع التجمع الخامس الكبرى.
              </p>
            ...
            >
              <p>
                تختلف مباني التجمع الخامس عن مباني القاهرة في عدة جوانب تؤثر على طريقة تنفيذ أعمال القص والتخريم:
              </p>
              <div className="not-prose grid gap-4 md:grid-cols-2 mt-6">
                {[
                  { t: 'المباني الكلاسيكية القديمة', d: 'عمائر التجمع الخامس القديمة تحتوي على خرسانة متقادمة أقل صلابة وأكثر حساسية للاهتزاز. نتعامل معها بماكينات منخفضة الدوران وتبريد مائي مكثف لضمان عدم تفتت الخرسانة المحيطة.', bg: 'bg-amber-50 border-amber-100' },
                  { t: 'الأبراج والعمارات الحديثة', d: 'الخرسانة عالية الإجهاد في أبراج التجمع الخامس الحديثة تحتاج أسطوانات ألماس بجودة عالية وضغط هيدروليكي أعلى. معداتنا مُهيّأة للتعامل مع أصعب أنواع الخرسانة الحديثة.', bg: 'bg-sky-50 border-sky-100' },
                  ...
                  { t: 'الفيلات والمنازل الساحلية', d: 'المنازل القريبة من البحر في التجمع الخامس تعاني أحياناً من تآكل الحديد الداخلي بفعل الرطوبة. نأخذ ذلك بعين الاعتبار عند المعاينة لتحديد النقاط الآمنة للقص والتخريم.', bg: 'bg-emerald-50 border-emerald-100' },
                ].map(x => (
