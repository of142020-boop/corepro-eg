...
export default function HoodsPage() {
 ...
 وفقاً لمواصفات الأمان لشركات الغاز، نقوم بعمل ثقب الكور المناسب لـ <strong>تركيب مدخنة سخان غاز</strong> وتوصيل الهواية الخارجية بشكل دقيق ومرتب.
  ...
  <h3 className="text-lg font-black text-slate-900 mb-2">مميزات تأسيس مدخنة الشفاط معنا:</h3>
  <ul className="list-disc pr-5 space-y-2 text-sm text-slate-700 leading-7">
  <li>تخريم الفتحة الخارجية بقطر مطابق تماماً لحجم الدكت (4 أو 5 أو 6 بوصة).</li>
