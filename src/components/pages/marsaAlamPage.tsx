...
const CANONICAL = `${DOMAIN}/concrete-cutting-marsa-alam`;
const PHONE     = '01021507462';
const PHONE_INT = '+201021507462';
const WHATSAPP  = 'https://wa.me/201021507462';

const MARSAALAM_AREAS = [
  'بورت غالب',
  'خليج كورايا',
  'أبو دباب',
  'مرسى شجرة',
  'القرى السياحية بمرسى علم',
  'جنوب البحر الأحمر'
];

const FAQ = [
  {
    q: 'هل تعملون في تخريم الكور وقص الخرسانة في مرسى علم؟',
    a: 'نعم، نقدم الخدمتين للمنتجعات السياحية والفنادق في مرسى علم وبورت غالب. تخريم الكور لفتحات التكييف والغاز والسباكة والصرف، وقص الخرسانة بالمنشار لفتح الأبواب والشبابيك وقص الأسقف. فريقنا يصل لأي موقع في محافظة مرسى علم.',
  },
  {
  ...
  {
    q: 'ما هي أقطار فتحات الكور المتاحة في مرسى علم؟',
  ...
  {
    q: 'هل تعملون في تأسيس فتحات الغاز وفق الاشتراطات في مرسى علم؟',
    a: 'نعم، ننفذ فتحات مواسير الغاز الطبيعي بالأقطار والمواصفات المطلوبة من شركة الغاز في مرسى علم. الفتحة دائرية منتظمة تماماً تسهل على فني الغاز تمرير الماسورة وتثبيتها بأمان.',
  },
  {
    q: 'هل يمكنكم قص جدار لفتح باب في منزلي بمرسى علم؟',
  ...
  {
    q: 'هل يتسبب العمل في غبار أو اهتزاز في منزلي بمرسى علم؟',
  ...
  {
    q: 'هل تعملون في المباني القديمة في مراكز مرسى علم؟',
    a: 'نعم. خبرتنا تشمل التعامل مع مباني مراكز مرسى علم القديمة ذات الخرسانة المتقادمة. نُقيّم طبيعة الخرسانة أولاً ونختار السرعة المناسبة لضمان فتحة نظيفة دون تفتت المواد المحيطة.',
  },
  {
    q: 'هل يمكنكم قص سقف لعمل سلم داخلي (دوبلكس) في مرسى علم؟',
    a: 'نعم. قص السقف الخرساني لعمل فتحة السلم الداخلي من خدماتنا في مرسى علم. ننفذه بمنشار السكة الهيدروليكي مع تأمين البلوك قبل الفصل النهائي لمنع السقوط.',
  },
  {
    q: 'كيف أحجز موعداً لخدمة في مرسى علم؟',
    a: `تواصل معنا على ${PHONE} أو واتساب وأخبرنا بنوع العمل وموقعك في مرسى علم. نُرتِّب المعاينة المجانية وعرض السعر بسرعة. يمكن تنفيذ القص والتخريم في نفس الزيارة إذا كنت تحتاج الخدمتين.`,
  },
];
  ...
  const jsonLd = [
    {
      ...
      description: 'كور برو متخصصون في تخريم الخرسانة بالكور وقص الخرسانة بالمنشار في مرسى علم — فتحات التكييف والغاز والسباكة وفتح الأبواب والشبابيك بدقة هندسية وبدون اهتزاز.',
      address: {
        '@type': 'PostalAddress',
        addressCountry: 'EG',
        addressLocality: 'Marsa Alam',
        addressRegion: 'Marsa Alam Governorate',
      },
      geo: { '@type': 'GeoCoordinates', latitude: 25.0676, longitude: 34.879 },
      areaServed: ['مرسى علم', 'Marsa Alam', ...MARSAALAM_AREAS],
      priceRange: '$$',
      ...
      hasOfferCatalog: {
        '@type': 'OfferCatalog',
        name: 'خدمات تخريم وقص الخرسانة في مرسى علم',
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'تخريم الخرسانة بالكور في مرسى علم', url: `${DOMAIN}/core` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'قص الخرسانة بالمنشار في مرسى علم', url: `${DOMAIN}/saw` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'فتحات الغاز والتكييف والسباكة بمرسى علم', url: `${DOMAIN}/core` } },
        ],
      },
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'تخريم الكور وقص الخرسانة في مرسى علم',
      serviceType: 'Concrete Core Drilling and Saw Cutting Marsa Alam',
      provider: { '@type': 'LocalBusiness', name: BRAND, telephone: PHONE_INT, url: DOMAIN },
      areaServed: ['Marsa Alam', 'مرسى علم', ...MARSAALAM_AREAS],
      url: CANONICAL,
      description: 'تخريم الخرسانة بالكور وقص الخرسانة بالمنشار في مرسى علم — فتحات التكييف والغاز والسباكة وفتح الأبواب والشبابيك. نخدم جميع مراكز مرسى علم.',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'تخريم الكور وقص الخرسانة في مرسى علم', item: CANONICAL },
      ],
    },
    {
      '@context': 'https://schema.org',
      ...
      name: 'تخريم الخرسانة بالكور في مرسى علم',
      description: 'ماكينة كور دريل هيدروليكية أثناء تخريم سقف خرساني في مرسى علم — كور برو',
    ...
    },
    {
      ...
      '@type': 'WebPage',
      url: CANONICAL,
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['#core-marsa-alam', '#saw-marsa-alam', '#faq', 'h1'] },
    },
  ];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-10 pb-14 md:pt-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-4 py-2 text-sm text-sky-800 shadow-sm mb-6">
            ...
            <span>يخدم جميع مراكز محافظة مرسى علم · تخريم بالكور · قص بالمنشار</span>
          </div>
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div>
              <h1 className="text-3xl md:text-5xl font-black leading-tight text-slate-900 border-r-8 border-sky-600 pr-4">
                صنايعي كور وقص الخرسانة في مرسى علم - 01021507462
              </h1>
              <div className="mt-5 text-slate-800 leading-9 space-y-4 text-lg">
                <p>
                  <strong>كور برو - Core Pro</strong> هو متخصصك الأول في <strong>تخريم الخرسانة بالكور في مرسى علم</strong>
                  و<strong>قص الخرسانة بالمنشار في مرسى علم</strong>. نقدم الخدمتين بأعلى معايير الجودة —
                  بدون اهتزاز، وبدون غبار، وبضمان سلامة الهيكل الإنشائي.
                </p>
                <p>
                  سواء كنت تحتاج <strong>صنايعي كور في مرسى علم</strong> لفتحات التكييف والغاز والسباكة،
                  أو <strong>فني قص خرسانة في مرسى علم</strong> لفتح باب أو شباك أو قص سقف دوبلكس —
                  فريقنا يصل لأي موقع في مرسى علم وينجز العمل باحترافية.
                </p>
              </div>

              {/* خدمتان واضحتان */}
              <div className="mt-7 grid grid-cols-2 gap-3">
                <a href="#core-marsa-alam" className="flex flex-col items-center gap-2 rounded-2xl border-2 border-sky-400 bg-sky-50 px-4 py-4 text-sm text-slate-800 shadow-sm font-bold text-center hover:bg-sky-100 transition">
                  <Ruler className="h-6 w-6 text-sky-600" />
                  تخريم بالكور
                  <span className="text-xs text-slate-500 font-medium">تكييف · غاز · سباكة · صرف</span>
                </a>
                <a href="#saw-marsa-alam" className="flex flex-col items-center gap-2 rounded-2xl border-2 border-amber-400 bg-amber-50 px-4 py-4 text-sm text-slate-800 shadow-sm font-bold text-center hover:bg-amber-100 transition">
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-slate-500">
                ...
                <span>معاينة مجانية · نصل لجميع مراكز مرسى علم</span>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-black/10 bg-white/80 backdrop-blur-xl shadow-[0_16px_60px_rgba(0,0,0,0.1)] p-7 space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-black text-slate-900 text-lg">تغطية محافظة مرسى علم</div>
                  <div className="text-sm text-slate-500">جميع المراكز والمدن</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2">
                {MARSAALAM_AREAS.map(area => (
      ...
      <div className="mx-auto max-w-6xl px-4 pb-24">
        <div className="grid gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-10 min-w-0">
            ...
            <Section id="core-marsa-alam" title="تخريم الخرسانة بالكور في مرسى علم (الخدمة الرئيسية)">
              <p>
                <strong>تخريم الخرسانة بالكور في مرسى علم</strong> هو تخصصنا الأبرز ويُمثل الطلب الأكثر في المنطقة.
              ...
              <div className="not-prose space-y-4 mt-6">
                <h3 className="text-xl font-black text-slate-900">أنواع فتحات الكور في مرسى علم:</h3>
                {[
                  { t: 'فتحة التكييف الاسبليت والمركزي', d: 'قطر 5-8 سم بميل مضبوط للخارج. الأكثر طلباً في مرسى علم. ننفذها بدقة لضمان خروج مياه التكثيف بشكل صحيح.', icon: Wind },
              ...
              <div className="not-prose mt-6">
                <h3 className="text-lg font-black text-slate-900 mb-4">دليل الأقطار الشائعة في مرسى علم:</h3>
              ...
              <div className="not-prose mt-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                <Image src="/images/core/fatahat-core-beton-1.webp" alt="تخريم الخرسانة بالكور في مرسى علم" width={800} height={533} className="w-full object-cover" loading="lazy" />
                <div className="bg-white px-4 py-2 text-xs text-slate-500">ماكينة كور دريل هيدروليكية أثناء تخريم سقف خرساني — كور برو مرسى علم</div>
              </div>
            </Section>

            {/* 2. قص المنشار - SECONDARY */}
            <Section id="saw-marsa-alam" title="قص الخرسانة بالمنشار في مرسى علم — فتح الأبواب والشبابيك والأسقف">
              <p>
                إلى جانب تخريم الكور، نقدم أيضاً <strong>قص الخرسانة بالمنشار في مرسى علم</strong>
            ...
            {/* 3. مراحل التنفيذ */}
            <Section id="process" title="مراحل التنفيذ في مرسى علم: من التواصل إلى التسليم">
              <div className="space-y-5 not-prose">
                {[
                  { n: '1', t: 'التواصل وتحديد نوع العمل', d: `تتصل بنا على ${PHONE} أو واتساب وتُخبرنا بالعمل المطلوب (تخريم أو قص أو كلاهما) وموقعك في مرسى علم.` },
            ...
            {/* 4. FAQ */}
            <Section id="faq" title="الأسئلة الشائعة عن تخريم الكور وقص الخرسانة في مرسى علم">
          ...
          <aside className="space-y-6 min-w-0">
            ...
            <div className="p-7 rounded-[40px] bg-white border border-black/10 shadow-lg">
              <h3 className="font-black text-xl text-slate-900 mb-5">لماذا كور برو بمرسى علم؟</h3>
              <div className="space-y-4">
                ...
                <StatPill icon={<MapPin className="h-4 w-4 text-rose-500" />} text="تغطية محافظة مرسى علم كاملة" />
          ...
          <div className="relative z-10 p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-500/20 text-sky-300 font-bold mb-5 text-sm border border-sky-500/30">
                ...
                تخريم الكور وقص الخرسانة في مرسى علم
              </div>
              <h2 className="text-2xl md:text-4xl font-black mb-4 leading-tight">جاهز لبدء مشروعك في مرسى علم؟</h2>
              <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                تواصل معنا الآن للحصول على معاينة مجانية وعرض سعر فوري. فريقنا جاهز لخدمتك في مرسى علم 7 أيام أسبوعياً.
              </p>
