...
const october_AREAS = [
  'أحياء 6 أكتوبر والشيخ زايد',
  'حدائق أكتوبر والشيخ زايد',
  'محور 26 يوليو ووصلة دهشور',
  'الحي المتميز والأشجار',
  'دريم لاند وبيفرلي هيلز',
  'أكتوبر الجديدة والواحات',
  'المنطقة الصناعية بأكتوبر',
  'حي الورود',
  'الربوة وزايد 2000',
  'زايد الجديدة',
  'عمارات الفردوس والزيتون',
  'منطقة جامعة مصر وجامعة أكتوبر',
];

const FAQ = [
  {
    q: 'هل تعملون في 6 أكتوبر والشيخ زايد بشكل دائم وليس موسمياً؟',
    a: 'نعم، لدينا فريق متخصص يغطي 6 أكتوبر والشيخ زايد بشكل كامل ودائم طوال العام. نخدم جميع أحياء 6 أكتوبر والشيخ زايد من مدينة 6 أكتوبر والشيخ زايد حتى حدائق أكتوبر والشيخ زايد وحي الورود، ونصل لموقعك في أسرع وقت ممكن.',
  },
  {
  ...
  {
    q: 'هل تعملون في الكومباوندات والمجمعات السكنية المغلقة في 6 أكتوبر والشيخ زايد؟',
  ...
  {
    q: 'هل يمكنكم الوصول لمنطقة 6 أكتوبر والشيخ زايد في نفس اليوم؟',
    a: 'نعم، لدينا فريق متمركز في منطقة أكتوبر ويمكنه الوصول لأي موقع في 6 أكتوبر والشيخ زايد وحدائق أكتوبر والشيخ زايد في غضون ساعات. في أغلب الحالات نقدر نرسلك الفريق في نفس اليوم أو في اليوم التالي على أبعد تقدير.',
  },
  {
    q: 'هل تعملون في أكتوبر الجديدة والواحات ومدن أكتوبر الأخرى القريبة من أكتوبر؟',
    a: 'بالتأكيد. نغطي أكتوبر الجديدة والواحات والعبور وجميع مدن أكتوبر المحيطة ب6 أكتوبر والشيخ زايد. المسافة لا تمثل عائقاً طالما الموقع في محيط شرق القاهرة.',
  },
  {
  ...
  const jsonLd = [
    {
      ...
      address: {
        '@type': 'PostalAddress',
        addressCountry: 'EG',
        addressLocality: 'October',
        addressRegion: 'Cairo Governorate',
      },
      geo: { '@type': 'GeoCoordinates', latitude: 31.2001, longitude: 29.9187 },
      areaServed: ['6 أكتوبر والشيخ زايد', 'October', ...october_AREAS],
      priceRange: '$$',
    ...
    },
    {
      ...
      serviceType: 'Concrete Cutting and Core Drilling October',
      provider: { '@type': 'LocalBusiness', name: BRAND, telephone: PHONE_INT, url: DOMAIN },
      areaServed: ['October', '6 أكتوبر والشيخ زايد', ...october_AREAS],
      url: CANONICAL,
    ...
    // ── Speakable schema for AI voice answers ──
    {
      ...
      speakable: {
        ...
        cssSelector: ['#saw-October', '#core-October', '#faq'],
      },
    },
  ];
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div>
              ...
              <div className="mt-5 text-slate-800 leading-9 space-y-4 text-lg">
                ...
                <p>
                  سواء كنت تحتاج <strong>معلم قص جدار ب6 أكتوبر والشيخ زايد</strong> لفتح باب أو شباك، أو <strong>صنايعي كور 6 أكتوبر والشيخ زايد</strong> لتمرير مواسير الغاز والتكييف،
            ...
            <div className="rounded-3xl border border-black/10 bg-white/80 backdrop-blur-xl shadow-[0_16px_60px_rgba(0,0,0,0.1)] p-7 space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">من حدائق أكتوبر والشيخ زايد حتى حي الورود</div>
                </div>
              </div>
      ...
      <div className="mx-auto max-w-6xl px-4 pb-24">
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-10 min-w-0">
            ...
            <Section id="saw-October" title="قص الخرسانة بالمنشار في 6 أكتوبر والشيخ زايد">
              <p>
              ...
              <p>
                كثير من عمائر 6 أكتوبر والشيخ زايد القديمة في الأحياء الداخلية كأكتوبر الأول وأكتوبر الثالث تحتاج لتوسعة فتحات الأبواب أو فتح مداخل جديدة.
            ...
            {/* 2. تخريم الكور */}
            <Section id="core-October" title="تخريم الخرسانة بالكور في 6 أكتوبر والشيخ زايد">
              <p>
              ...
              <p>
                يستخدم <strong>صنايعي كور 6 أكتوبر والشيخ زايد</strong> من فريقنا نظام التبريد المائي (Wet Core Drilling)
              ...
              <div className="not-prose mt-6 space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    ...
                    { icon: Fan, color: 'text-emerald-500', bg: 'bg-emerald-50', t: 'فتحات الشفاطات والمداخن', d: 'فتحة المدخنة ومسار الدكت بالقطر المناسب للشفاط مع إنهاء التشطيب في زيارة واحدة ب6 أكتوبر والشيخ زايد.' },
                  ].map(x => (
            ...
            <Section id="comparison" title="قص الخرسانة الاحترافي مقابل التكسير التقليدي في 6 أكتوبر والشيخ زايد">
              <p>
                ...
                وهذا قد يُشكّل خطراً حقيقياً على مباني 6 أكتوبر والشيخ زايد القديمة التي تعاني أصلاً من التقادم وضعف البنية الإنشائية مع مرور السنين.
                اليك مقارنة موضوعية:
              </p>
            ...
            {/* 4. الشفاطات */}
            <Section id="hoods-October" title="تركيب شفاطات المطابخ والحمامات ب6 أكتوبر والشيخ زايد">
              <p>
              ...
              <div className="not-prose grid gap-4 md:grid-cols-3 mt-6">
                {[
                  { t: 'شفاطات بمدخنة خارجية', d: 'نُخرِّم الفتحة في الجدار الخارجي ونوصل الدكت مع إنهاء التشطيب بشكل أنيق — مناسب لفيلات وشقق أكتوبر.' },
                  { t: 'شفاطات بفلتر كربوني', d: 'للشقق التي لا يمكن فيها عمل فتحة خارجية — الحل الأنسب لأبراج 6 أكتوبر والشيخ زايد وحدائق أكتوبر عالية الطوابق.' },
                  { t: 'شفاطات حمام مركزية', d: 'تركيب شبكة دكت مركزية لطرد الرطوبة المتراكمة في الحمامات — مطلوب بكثرة في الوحدات الكبيرة ب6 أكتوبر والشيخ زايد.' },
                ].map(x => (
            ...
            {/* 5. الواير الماسي */}
            <Section id="wire-October" title="قص الخرسانة بالواير الماسي في 6 أكتوبر والشيخ زايد — المشاريع الكبرى">
              <p>
                ...
                التي تفوق قدرة المنشار التقليدي — مثل قص أساسات المشاريع العملاقة، هدم الكباري الخرسانية، وقواعد الماكينات الثقيلة في المناطق الصناعية بمحيط أكتوبر.
              </p>
              <p>
                ...
                لا يوجد حد أقصى لسماكة الخرسانة — مما يجعله مثالياً لمشاريع 6 أكتوبر والشيخ زايد وأكتوبر الكبرى.
              </p>
            ...
            <Section
              id="october-buildings"
              title="تحديات مباني 6 أكتوبر والشيخ زايد وكيف نتعامل معها"
              subtitle="خبرة متراكمة في خصوصية مباني أكتوبر"
            >
              <p>
                تتميز مباني 6 أكتوبر والشيخ زايد بتنوعها بين عمائر قديمة وكومباوندات حديثة، وهو ما يتطلب خبرة متخصصة للتعامل مع كل نوع:
              </p>
              <div className="not-prose grid gap-4 md:grid-cols-2 mt-6">
                {[
                  { t: 'العمائر والمباني القديمة', d: 'عمائر مدينة 6 أكتوبر والشيخ زايد القديمة تحتوي على خرسانة متقادمة أقل صلابة وأكثر حساسية للاهتزاز. نتعامل معها بماكينات منخفضة الدوران وتبريد مائي مكثف لضمان عدم تفتت الخرسانة المحيطة.', bg: 'bg-amber-50 border-amber-100' },
                  { t: 'أبراج وكومباوندات حدائق أكتوبر والشيخ زايد', d: 'الخرسانة عالية الإجهاد في أبراج المجمعات السكنية الحديثة تحتاج أسطوانات ألماس بجودة عالية وضغط هيدروليكي أعلى. معداتنا مُهيّأة للتعامل مع أصعب أنواع الخرسانة الحديثة.', bg: 'bg-sky-50 border-sky-100' },
                  { t: 'المشاريع الصناعية والتجارية', d: 'المناطق التجارية والصناعية في محيط أكتوبر تضم منشآت بجدران وأرضيات خرسانية ثقيلة. نملك معدات الواير الماسي والمنشار الهيدروليكي الثقيل لهذا النوع من المشاريع.', bg: 'bg-violet-50 border-violet-100' },
                  { t: 'فيلات وبيوت مستقلة', d: 'الفيلات والمنازل المستقلة في أحياء الحي المتميز ودريم لاند والنرجس تتميز بجدران أكثر سماكة وتصميمات معمارية خاصة. نتعامل معها بدقة لضمان الحفاظ على الشكل الجمالي للمبنى.', bg: 'bg-emerald-50 border-emerald-100' },
                ].map(x => (
