...
const CANONICAL = `${DOMAIN}/concrete-cutting-october`;
...
const OCT_AREAS = [
  'المنتزه وسيدي بشر',
  'ميامي والعصافرة وأبو قير',
  'فيكتوريا وكليوباترا',
  'سموحة والأزاريطة',
  'سيدي جابر وبحري',
  'الإبراهيمية ومحرم بك',
  'كامب شيزار والرملة',
  'العجمي والهانوفيل',
  'الدخيلة والمكس',
  'برج العرب الجديدة',
  'مدينة برج العرب الصناعية',
  'وسط 6 أكتوبر والشيخ زايد والكورنيش',
];

const FAQ = [
  {
    q: 'هل تعملون في 6 أكتوبر والشيخ زايد بشكل دائم وليس موسمياً؟',
    a: 'نعم، لدينا فريق متخصص يغطي 6 أكتوبر والشيخ زايد بشكل كامل ودائم طوال العام. نخدم جميع أحياء 6 أكتوبر والشيخ زايد من المنتزه شرقاً حتى العجمي والدخيلة غرباً ونصل لموقعك في أسرع وقت ممكن.',
  },
  {
    q: 'هل تختلف أسعار قص الخرسانة في 6 أكتوبر والشيخ زايد عن القاهرة؟',
  ...
  {
    q: 'هل تعملون في المباني القديمة والكلاسيكية في وسط 6 أكتوبر والشيخ زايد؟',
    a: 'نعم، ولدينا خبرة خاصة في التعامل مع خرسانة المباني القديمة والعمائر الكلاسيكية في 6 أكتوبر والشيخ زايد. نقوم بمعاينة دقيقة لتحديد طبيعة الخرسانة ومستوى التسليح أولاً، مما يضمن تنفيذ العمل بأمان دون المساس بسلامة الهيكل الإنشائي القديم.',
  },
  {
    q: 'هل تؤثر رطوبة وملوحة هواء 6 أكتوبر والشيخ زايد على جودة العمل؟',
    a: 'لا تأثير على جودة التنفيذ إطلاقاً. نستخدم معدات مقاومة للرطوبة مُهيّأة للبيئات الساحلية. تقنية التبريد المائي التي نعتمدها تجعل العملية مناسبة لجميع الأجواء بما فيها الجو الرطب، بل إن الرطوبة لا تؤثر على أداء أسطوانات الألماس التي نستخدمها.',
  },
  {
    q: 'هل تعملون في المناطق الصناعية كالدخيلة وبرج العرب؟',
    a: 'بالتأكيد. نخدم المنطقة الصناعية في الدخيلة وبرج العرب الصناعية بمعدات ثقيلة مناسبة للمشاريع الصناعية الكبيرة. لدينا خبرة في قص خرسانة المصانع والمستودعات وقواعد الماكينات الصناعية الضخمة.',
  },
  {
    q: 'كم تستغرق عملية قص جدار كامل لفتح باب في 6 أكتوبر والشيخ زايد؟',
  ...
  {
    q: 'هل عملية التخريم بالكور في 6 أكتوبر والشيخ زايد نظيفة للشقق المفروشة؟',
    a: 'نعم تماماً. نعتمد على نظام التبريد المائي (Wet Core Drilling) الذي يحوّل الغبار إلى معجون سائل يُسحب فوراً. لا يتصاعد أي غبار في الهواء، مما يجعل العملية مثالية للشقق المسكونة والمفروشة في 6 أكتوبر والشيخ زايد.',
  },
  {
  ...
  {
    q: 'ما الفرق بين قص الخرسانة بالمنشار والتكسير بالصاروخ في 6 أكتوبر والشيخ زايد؟',
    a: 'التكسير بالصاروخ العادي يُحدث اهتزازات تُشقق الجدران المجاورة وقد تُضعف الأعمدة والأساسات — خاصة في مباني 6 أكتوبر والشيخ زايد القديمة ذات الخرسانة الهشة. أما القص بالمنشار الماسي فيعتمد على القطع السلس دون اهتزاز واحد، مما يضمن سلامة المبنى بنسبة 100%.',
  },
  {
    q: 'هل تقدمون ضماناً على جودة العمل في 6 أكتوبر والشيخ زايد؟',
    a: 'نعم. نقف خلف كل عمل ننفذه. إذا ظهرت أي مشكلة ناتجة عن تنفيذنا، نعود لموقعك في 6 أكتوبر والشيخ زايد فوراً لمعالجتها دون تكاليف إضافية. سمعتنا هي رأس مالنا الأول.',
  },
];
  ...
  const jsonLd = [
    {
      ...
      description: 'كور برو - Core Pro متخصصون في قص الخرسانة بالمنشار وتخريم الكور وتركيب الشفاطات ب6 أكتوبر والشيخ زايد بدقة هندسية وأمان كامل.',
      address: {
        '@type': 'PostalAddress',
        addressCountry: 'EG',
      ...
      areaServed: ['6 أكتوبر والشيخ زايد', '6th of October', ...OCT_AREAS],
      priceRange: '$$',
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'قص خرسانة 6 أكتوبر والشيخ زايد بالمنشار', url: `${DOMAIN}/saw` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'تخريم الخرسانة بالكور في 6 أكتوبر والشيخ زايد', url: `${DOMAIN}/core` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'تركيب شفاطات المطابخ ب6 أكتوبر والشيخ زايد', url: `${DOMAIN}/hoods` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'قص الخرسانة بالواير الماسي ب6 أكتوبر والشيخ زايد', url: `${DOMAIN}/wire` } },
        ],
      },
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'قص وتخريم الخرسانة ب6 أكتوبر والشيخ زايد',
      serviceType: 'Concrete Cutting and Core Drilling 6th of October',
      provider: { '@type': 'LocalBusiness', name: BRAND, telephone: PHONE_INT, url: DOMAIN },
      areaServed: ['6th of October', '6 أكتوبر والشيخ زايد', ...OCT_AREAS],
      url: CANONICAL,
      description: 'خدمات متكاملة لقص الخرسانة بالمنشار وتخريم الكور وتركيب الشفاطات في 6 أكتوبر والشيخ زايد. نخدم جميع أحياء 6 أكتوبر والشيخ زايد بمعدات حديثة وبدون اهتزازات.',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'قص وتخريم خرسانة 6 أكتوبر والشيخ زايد', item: CANONICAL },
      ],
    },
    // ── ImageObject schemas for Google Image Search ──
    {
      ...
      name: 'قص الخرسانة بالمنشار الماسي في 6 أكتوبر والشيخ زايد',
      description: 'قص جدار خرساني بالمنشار الماسي مع التبريد المائي الكامل — خدمة كور برو في 6 أكتوبر والشيخ زايد',
    ...
    },
    {
      ...
      name: 'تخريم الخرسانة بالكور الماسي في 6 أكتوبر والشيخ زايد',
      description: 'ماكينة كور دريل هيدروليكية أثناء تخريم السقف الخرساني بالتبريد المائي — كور برو 6 أكتوبر والشيخ زايد',
      author: { '@type': 'Organization', name: BRAND, url: DOMAIN },
      copyrightHolder: { '@type': 'Organization', name: BRAND },
      creditText: 'كور برو - Core Pro',
      acquireLicensePage: CANONICAL,
    ...
    },
    {
      ...
      name: 'تركيب شفاطات المطابخ ب6 أكتوبر والشيخ زايد',
      description: 'شفاطات مطابخ مركبة على السطح بمنافذ خارجية محكمة ضد رطوبة هواء 6 أكتوبر والشيخ زايد — كور برو',
      author: { '@type': 'Organization', name: BRAND, url: DOMAIN },
      copyrightHolder: { '@type': 'Organization', name: BRAND },
      creditText: 'كور برو - Core Pro',
      acquireLicensePage: CANONICAL,
    ...
    },
    {
      ...
      name: 'قص الخرسانة بالواير الماسي في 6 أكتوبر والشيخ زايد',
      description: 'ماكينة الواير الماسي أثناء قص خرسانة ضخمة في مشروع بنية تحتية كبير — كور برو 6 أكتوبر والشيخ زايد',
      author: { '@type': 'Organization', name: BRAND, url: DOMAIN },
      copyrightHolder: { '@type': 'Organization', name: BRAND },
      creditText: 'كور برو - Core Pro',
      acquireLicensePage: CANONICAL,
    ...
    // ── HowTo schema for process steps (AI Overviews) ──
    {
      '@context': 'https://schema.org',
      '@type': 'HowTo',
      name: 'كيف تطلب خدمة قص وتخريم الخرسانة من كور برو ب6 أكتوبر والشيخ زايد؟',
      description: 'خطوات بسيطة للحصول على خدمة قص أو تخريم الخرسانة في 6 أكتوبر والشيخ زايد من كور برو',
      totalTime: 'PT24H',
      tool: [
      ...
      step: [
        {
          ...
          text: 'تواصل مع كور برو عبر واتساب أو الاتصال على 01021507462 وأخبرنا بنوع العمل المطلوب وموقعك في 6 أكتوبر والشيخ زايد.',
        ...
        },
        {
          ...
          text: 'يصل فريقنا لموقعك في 6 أكتوبر والشيخ زايد لمعاينة الموقع بالكاشف الإلكتروني وتقديم عرض سعر نهائي مجاناً.',
          url: `${CANONICAL}#process`,
        },
        {
          '@type': 'HowToStep',
    ...
    // ── Speakable schema for AI voice answers ──
    {
      ...
      speakable: {
        ...
        cssSelector: ['#saw-6th of October', '#core-6th of October', '#faq'],
      },
    },
  ];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-10 pb-14 md:pt-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-4 py-2 text-sm text-sky-800 shadow-sm mb-6">
            ...
            <span>يخدم جميع أحياء 6 أكتوبر والشيخ زايد · قص · تخريم · شفاطات · واير</span>
          </div>

          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div>
              <h1 className="text-3xl md:text-5xl font-black leading-tight text-slate-900 border-r-8 border-sky-600 pr-4">
                قص وتخريم خرسانة 6 أكتوبر والشيخ زايد — {PHONE}
              </h1>

              <div className="mt-5 text-slate-800 leading-9 space-y-4 text-lg">
                <p>
                  <strong>كور برو - Core Pro</strong> هو متخصصك الأول في <strong>قص الخرسانة ب6 أكتوبر والشيخ زايد</strong> وتخريم الكور وتركيب الشفاطات.
                  نقدم خدماتنا لأهالي 6 أكتوبر والشيخ زايد في كافة الأحياء بأحدث معدات القطع الماسي والتخريم الهيدروليكي —
                  <strong> بدون اهتزازات، وبدون غبار، وبضمان سلامة الهيكل الإنشائي.</strong>
                </p>
                <p>
                  سواء كنت تحتاج <strong>معلم قص جدار ب6 أكتوبر والشيخ زايد</strong> لفتح باب أو شباك، أو <strong>صنايعي كور اسكندرية</strong> لتمرير مواسير الغاز والتكييف،
                  أو <strong>فني تركيب شفاط مطبخ ب6 أكتوبر والشيخ زايد</strong> — فريقنا المتخصص يصل إليك ويُنجز المهمة بسرعة ودقة عالية.
                </p>
              </div>
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-slate-500">
                ...
                <span>معاينة مجانية · نصل خلال 24 ساعة في 6 أكتوبر والشيخ زايد</span>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-black/10 bg-white/80 backdrop-blur-xl shadow-[0_16px_60px_rgba(0,0,0,0.1)] p-7 space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-black text-slate-900 text-lg">تغطية كاملة للإسكندرية</div>
                  <div className="text-sm text-slate-500">من المنتزه شرقاً حتى العجمي غرباً</div>
                </div>
              </div>
      ...
      <div className="mx-auto max-w-6xl px-4 pb-24">
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-10 min-w-0">
            ...
            <Section id="saw-6th of October" title="قص الخرسانة بالمنشار في 6 أكتوبر والشيخ زايد">
              <p>
                تقنية <strong>قص الخرسانة بالمنشار في 6 أكتوبر والشيخ زايد</strong> هي الحل الهندسي الأمثل لإجراء تعديلات معمارية على المباني القائمة بدون تدمير الهيكل الإنشائي.
              ...
              <p>
                كثير من مباني 6 أكتوبر والشيخ زايد القديمة في الأحياء المركزية كالإبراهيمية وسيدي جابر وبحري تحتاج لتوسعة فتحات الأبواب أو فتح مداخل جديدة.
                <strong>معلم قص جدار ب6 أكتوبر والشيخ زايد</strong> من فريقنا يدرس المقطع الإنشائي أولاً، يحدد مسار الحديد بالأجهزة المتخصصة،
                ثم ينفذ القص بدقة جراحية وبتبريد مائي كامل يمنع أي غبار.
              </p>
              <div className="not-prose space-y-4 mt-6">
                <h3 className="text-xl font-black text-slate-900">خدمات قص الخرسانة التي نقدمها في 6 أكتوبر والشيخ زايد:</h3>
                {[
                  ...
                  { t: 'قص السقف لعمل فتحات السلالم (دوبلكس)', d: 'دمج شقتين رأسياً في 6 أكتوبر والشيخ زايد؟ نقوم بقص الأسقف الخرسانية بأمان تام لعمل فتحة السلم الداخلي مع تأمين البلوك قبل فصله لمنع السقوط المفاجئ.' },
                  { t: 'قص الخرسانة لتمرير المصاعد', d: 'تأسيس بئر المصعد يتطلب قص أسقف متعددة بدقة هندسية. نملك الخبرة والمعدات اللازمة لتنفيذ هذا النوع من المشاريع في مباني 6 أكتوبر والشيخ زايد.' },
              ...
              <div className="not-prose mt-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                <Image
                  ...
                  alt="قص الخرسانة بالمنشار الماسي في 6 أكتوبر والشيخ زايد — كور برو"
                  width={900}
                  height={500}
            ...
            {/* 2. تخريم الكور */}
            <Section id="core-6th of October" title="تخريم الخرسانة بالكور في 6 أكتوبر والشيخ زايد">
              <p>
                <strong>تخريم الخرسانة بالكور في 6 أكتوبر والشيخ زايد</strong> هو إحداث فتحات أسطوانية دقيقة في الجدران والأسقف الخرسانية باستخدام ماكينة كور دريل مزودة بأسطوانات ألماسية.
                الفتحة الناتجة تكون دائرية تماماً، ناعمة الحواف من الداخل، بقطر مضبوط بالملليمتر — بدون أي اهتزاز أو تشقق للسطح المحيط.
              </p>
              <p>
                يستخدم <strong>صنايعي كور اسكندرية</strong> من فريقنا نظام التبريد المائي (Wet Core Drilling)
                الذي يحوّل الأتربة لمعجون سائل يُسحب فوراً، مما يجعل العملية <strong>نظيفة 100% حتى في الشقق المفروشة</strong>.
              </p>
              <div className="not-prose mt-6 space-y-4">
                <h3 className="text-xl font-black text-slate-900">أبرز استخدامات تخريم الكور في 6 أكتوبر والشيخ زايد:</h3>
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    { icon: Flame, color: 'text-orange-500', bg: 'bg-orange-50', t: 'فتحات الغاز الطبيعي', d: 'فتحات بالأقطار المطابقة لاشتراطات شركات الغاز في 6 أكتوبر والشيخ زايد مع ضمان استقامة المسار.' },
                    { icon: Wind, color: 'text-sky-500', bg: 'bg-sky-50', t: 'فتحات التكييف والتهوية', d: 'فتحات بميل مضبوط للـ split وتمرير دكتات التكييف المركزي في فيلات وأبراج 6 أكتوبر والشيخ زايد.' },
                    ...
                    { icon: Fan, color: 'text-emerald-500', bg: 'bg-emerald-50', t: 'فتحات الشفاطات والمداخن', d: 'فتحة المدخنة ومسار الدكت بالقطر المناسب للشفاط مع ضمان الإحكام ضد رطوبة هواء 6 أكتوبر والشيخ زايد.' },
                  ].map(x => (
              ...
              <div className="not-prose mt-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                <Image
                  ...
                  alt="تخريم الخرسانة بالكور الماسي في 6 أكتوبر والشيخ زايد — كور برو"
                  width={900}
                  height={500}
                  className="w-full object-cover max-h-72"
                />
            ...
            {/* 3. مقارنة */}
            <Section id="comparison" title="قص الخرسانة الاحترافي مقابل التكسير التقليدي في 6 أكتوبر والشيخ زايد">
              <p>
                لا يزال بعض مقاولي 6 أكتوبر والشيخ زايد يلجؤون إلى <strong>التكسير بالهيلتي أو الصاروخ اليدوي</strong> لفتح الفتحات،
                وهذا قد يُشكّل خطراً حقيقياً على مباني 6 أكتوبر والشيخ زايد القديمة التي تعاني أصلاً من التقادم وتأثير رطوبة البحر على الخرسانة.
                اليك مقارنة موضوعية:
              </p>
            ...
            {/* 4. الشفاطات */}
            <Section id="hoods-6th of October" title="تركيب شفاطات المطابخ والحمامات ب6 أكتوبر والشيخ زايد">
              <p>
                نقدم خدمة <strong>تركيب شفاط المطبخ ب6 أكتوبر والشيخ زايد</strong> بشكل متكامل — من تخريم الفتحة بالكور بالقطر والميل الصحيحين،
              ...
              <p>
                نعلم أن رطوبة الجو الساحلي في 6 أكتوبر والشيخ زايد تعني أن <strong>اختيار الشفاط المناسب</strong> له أهمية خاصة.
                نحن نتعامل مع جميع ماركات الشفاطات المتوفرة في السوق المصري: توشيبا، فريش، تورنيدو، إليكا، باناسونيك، KDK، شارب، أريستون،
                سواء كانت بمدخنة (تحتاج فتحة خارجية) أو بفلتر كربوني (لا تحتاج فتحة).
              </p>
              <div className="not-prose grid gap-4 md:grid-cols-3 mt-6">
                {[
                  { t: 'شفاطات بمدخنة خارجية', d: 'نُخرِّم الفتحة في الجدار الخارجي للإسكندرية ونوصل الدكت مع إحكام التسديد ضد رطوبة هواء البحر.' },
                  { t: 'شفاطات بفلتر كربوني', d: 'للشقق التي لا يمكن فيها عمل فتحة خارجية — الحل الأنسب لأبراج 6 أكتوبر والشيخ زايد عالية الطوابق.' },
                  { t: 'شفاطات حمام مركزية', d: 'تركيب شبكة دكت مركزية لطرد الرطوبة المتراكمة في الحمامات — ضرورة في مناخ 6 أكتوبر والشيخ زايد الرطب.' },
                ].map(x => (
              ...
              <div className="not-prose mt-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                <Image
                  ...
                  alt="تركيب شفاطات المطابخ والمداخن ب6 أكتوبر والشيخ زايد — كور برو"
                  width={900}
                  height={500}
                  className="w-full object-cover max-h-72"
                />
                <p className="text-center text-xs text-slate-400 py-2 bg-slate-50">شفاطات مطابخ مركبة على السطح بمنافذ خارجية محكمة ضد رطوبة هواء 6 أكتوبر والشيخ زايد</p>
              </div>
            </Section>

            {/* 5. الواير الماسي */}
            <Section id="wire-6th of October" title="قص الخرسانة بالواير الماسي في 6 أكتوبر والشيخ زايد — المشاريع الكبرى">
              <p>
                <strong>قص الخرسانة بالواير الماسي (Diamond Wire Sawing) ب6 أكتوبر والشيخ زايد</strong> هو الحل النهائي لمشاريع البنية التحتية الكبرى
                التي تفوق قدرة المنشار التقليدي — مثل قص كباري كورنيش 6 أكتوبر والشيخ زايد، قواعد الأرصفة البحرية، الأساسات الضخمة، وقواعد الماكينات الصناعية في الدخيلة وبرج العرب.
              </p>
              <p>
                ...
                لا يوجد حد أقصى لسماكة الخرسانة — مما يجعله مثالياً لمشاريع 6 أكتوبر والشيخ زايد الكبرى.
              </p>
              ...
              <div className="not-prose mt-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                <Image
                  ...
                  alt="قص الخرسانة بالواير الماسي في 6 أكتوبر والشيخ زايد — مشاريع كبرى — كور برو"
                  width={900}
                  height={500}
                  className="w-full object-cover max-h-72"
                />
            ...
            <Section
              id="pricing"
              title="دليل أسعار قص وتخريم الخرسانة في 6 أكتوبر والشيخ زايد"
              subtitle="سياسة التسعير الشفاف — لا توجد أسعار مخفية أو مفاجآت"
            >
              <p>
                <strong>أسعار قص الخرسانة في 6 أكتوبر والشيخ زايد</strong> تتحدد بناءً على معايير هندسية واضحة وليس جزافاً.
              ...
              <div className="not-prose mt-6 space-y-4">
                ...
                <div className="rounded-3xl overflow-hidden border border-slate-200 bg-white shadow-sm">
                  <div className="bg-slate-900 p-5">
                    <h3 className="text-lg font-black text-sky-400">عوامل تسعير قص الخرسانة ب6 أكتوبر والشيخ زايد</h3>
                  </div>
                  <div className="divide-y divide-slate-100">
                    {[
                      ...
                      {
                        icon: '📍', t: 'موقع العمل داخل 6 أكتوبر والشيخ زايد',
                ...
                <div className="rounded-2xl bg-sky-50 border border-sky-200 p-6 flex gap-4">
                  ...
                  <div>
                    <div className="font-black text-slate-900 mb-1">خصم خاص للمقاولين وأصحاب المشاريع في 6 أكتوبر والشيخ زايد</div>
                    <p className="text-slate-600 text-sm leading-7">
                      نقدم تسعيراً خاصاً للمقاولين والمكاتب الهندسية وأصحاب المشاريع الكبيرة ب6 أكتوبر والشيخ زايد عند التعاقد على كميات
            ...
            {/* 7. مباني 6 أكتوبر والشيخ زايد */}
            <Section
              id="alx-buildings"
              title="تحديات مباني 6 أكتوبر والشيخ زايد وكيف نتعامل معها"
              subtitle="خبرة متراكمة في خصوصية البناء الساحلي المصري"
            >
              <p>
                تختلف مباني 6 أكتوبر والشيخ زايد عن مباني القاهرة في عدة جوانب تؤثر على طريقة تنفيذ أعمال القص والتخريم:
              </p>
              <div className="not-prose grid gap-4 md:grid-cols-2 mt-6">
                {[
                  { t: 'المباني الكلاسيكية القديمة', d: 'عمائر 6 أكتوبر والشيخ زايد القديمة تحتوي على خرسانة متقادمة أقل صلابة وأكثر حساسية للاهتزاز. نتعامل معها بماكينات منخفضة الدوران وتبريد مائي مكثف لضمان عدم تفتت الخرسانة المحيطة.', bg: 'bg-amber-50 border-amber-100' },
                  { t: 'الأبراج والعمارات الحديثة', d: 'الخرسانة عالية الإجهاد في أبراج 6 أكتوبر والشيخ زايد الحديثة تحتاج أسطوانات ألماس بجودة عالية وضغط هيدروليكي أعلى. معداتنا مُهيّأة للتعامل مع أصعب أنواع الخرسانة الحديثة.', bg: 'bg-sky-50 border-sky-100' },
                  { t: 'المصانع والمنشآت الصناعية', d: 'منطقة الدخيلة وبرج العرب الصناعية تضم منشآت بجدران وأرضيات خرسانية ثقيلة. نملك معدات الواير الماسي والمنشار الهيدروليكي الثقيل لهذا النوع من المشاريع.', bg: 'bg-violet-50 border-violet-100' },
                  { t: 'الفيلات والمنازل الساحلية', d: 'المنازل القريبة من البحر في 6 أكتوبر والشيخ زايد تعاني أحياناً من تآكل الحديد الداخلي بفعل الرطوبة. نأخذ ذلك بعين الاعتبار عند المعاينة لتحديد النقاط الآمنة للقص والتخريم.', bg: 'bg-emerald-50 border-emerald-100' },
                ].map(x => (
            ...
            {/* 8. مراحل التنفيذ */}
            <Section id="process" title="مراحل تنفيذ العمل في 6 أكتوبر والشيخ زايد: من التواصل إلى التسليم">
              <div className="space-y-6 not-prose">
                {[
                  { n: '1', t: 'التواصل وتحديد المتطلبات', d: 'تتواصل معنا عبر واتساب أو الاتصال وتشرح نوع العمل المطلوب (قص أو تخريم أو تركيب)، الموقع في 6 أكتوبر والشيخ زايد، وطبيعة الجدار أو السقف.' },
                  { n: '2', t: 'المعاينة الميدانية المجانية', d: 'يصل فريقنا لموقعك في 6 أكتوبر والشيخ زايد لمعاينة الموقع بالكاشف الإلكتروني لتحديد أماكن حديد التسليح، ثم نُقدم عرض سعر نهائياً ومحدداً بدون أي رسوم مخفية.' },
            ...
            {/* 9. FAQ */}
            <Section id="faq" title="الأسئلة الشائعة عن خدمات قص وتخريم الخرسانة ب6 أكتوبر والشيخ زايد">
          ...
          <aside className="space-y-6 min-w-0">
            ...
            <div className="p-7 rounded-[40px] bg-sky-600 text-white shadow-xl relative overflow-hidden sticky top-20">
              ...
              <p className="text-sky-100 text-sm mb-5 leading-7">
                فريقنا في 6 أكتوبر والشيخ زايد يصل إليك ويُقدم عرض سعر فوري — بدون أي التزام.
              </p>
              <a href={WHATSAPP} target="_blank" rel="noopener noreferrer"
            ...
            <div className="p-7 rounded-[40px] bg-white border border-black/10 shadow-lg">
              <h3 className="font-black text-xl text-slate-900 mb-5">لماذا نحن الخيار الأول ب6 أكتوبر والشيخ زايد؟</h3>
              <div className="space-y-4">
                ...
                <StatPill icon={<MapPin className="h-4 w-4 text-rose-500" />} text="تغطية كاملة للإسكندرية" />
          ...
          <div className="relative z-10 p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-500/20 text-sky-300 font-bold mb-5 text-sm border border-sky-500/30">
                ...
                خدمة متخصصة ب6 أكتوبر والشيخ زايد
              </div>
              <h2 className="text-2xl md:text-4xl font-black mb-4 leading-tight">
                جاهز لبدء مشروعك في 6 أكتوبر والشيخ زايد؟
              </h2>
              <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                تواصل معنا الآن للحصول على معاينة مجانية وعرض سعر فوري. فريقنا في 6 أكتوبر والشيخ زايد جاهز 7 أيام أسبوعياً.
              </p>
