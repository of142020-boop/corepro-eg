...
export default function SawPage() {
 ...
 <div className="mb-8">
            ...
            <div className="mb-6 text-slate-700 leading-8">
              نحن نستخدم <strong>صاروخ قص الخرسانة</strong> الاحترافي المزود بمدخل للمياه. هذا الـ <strong>صاروخ تقطيع الخرسانة</strong> يقص بعمق يصل إلى 15 سم بفضل أسطوانات الألماس المتطورة، وهو يختلف تماماً عن <strong>تكسير الجدار بالصاروخ</strong> العادي.
            </div>
