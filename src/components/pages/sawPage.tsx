...
export default function SawPage() {
 ...
 <div className="mt-4 grid grid-cols-2 gap-3 not-prose">
   {[
     ...
     { t: 'فتح شباك أو توسعته', d: 'قص مستقيم بدون ترميم' },
     { t: 'إزالة جدار كامل', d: 'بأمان تام وبدون اهتزاز' },
 ...
 <p className="mt-2">
   <strong>قص خرسانة السقف</strong> يُنجز في يوم واحد مع تسليم الفتحة نظيفة جاهزة للتشطيب — بدون أي غبار أو اهتزاز يؤثر على الطابق السفلي. هذا ما يميزنا كـ <strong>أفضل شركة قص خرسانة</strong> في تأمين مواقع العمل.
 </p>
 </div>
