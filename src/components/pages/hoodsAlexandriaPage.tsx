...
export default function HoodsAlexandriaPage() {
 ...
 <p>
 عندما تحتاج إلى <strong>تأسيس شفاط المطبخ</strong> أو تبحث عن أفضل <strong>شركات تركيب شفاطات المطابخ</strong>، نحن في <strong>{BRAND}</strong> نقدم لك الخدمة الأكثر احترافية في مصر. فريقنا يضم أفضل <strong>فني تركيب شفاط مطبخ</strong> متخصص يتعامل مع جميع أنواع الشفاطات، بما في ذلك <strong>تركيب شفاط زجاج</strong> بدقة شديدة — بدءاً من تأسيس فتحة الكور حتى اختبار كفاءة الشفط النهائي.
 </p>
 <p>
 ...
 <strong>تركيب شفاط هرمي</strong> بمدخنة يحتاج <strong>فتح كور في السقف</strong> أو الجدار. نعمل الفتحة بالكور لتوصيل الدكت الألومنيوم للمطابخ المكشوفة.
 </p>
 </div>
 <div className="p-6 bg-orange-50 border border-orange-100 rounded-3xl shadow-sm">
 <h3 className="font-black text-slate-900 mb-2">تركيب شفاط مطبخ مسطح</h3>
 <p className="text-slate-600 text-sm leading-7">
 لدينا خبرة في <strong>طريقة تركيب الشفاط المسطح</strong> بجميع <strong>مقاسات الشفاط المسطح</strong> (سواء 60 أو 90 سم)، نوفر <strong>تركيب شفاط بلت ان</strong> بكفاءة عالية.
 </p>
 </div>
 <div className="p-6 bg-white border border-black/5 rounded-3xl shadow-sm">
 <h3 className="font-black text-slate-900 mb-2">تركيب الشفاط في الشباك والزجاج</h3>
 <p className="text-slate-600 text-sm leading-7">
 لدينا فنيون محترفون في <strong>عمل فتحة شفاط في الزجاج</strong>. نضمن <strong>قص زجاج لعمل شفاط</strong> بدقة متناهية وبدون كسر، للحصول على <strong>فتحة شفاط زجاج</strong> مثالية تمنع تسرب الحشرات والهواء الخارجي.
 </p>
 </div>
 ...
 <p className="text-slate-600 text-sm leading-7">
 نتخصص في <strong>تركيب شفاط حمام</strong> حائطي وسقفي. نقوم بتأسيس <strong>فتحة شفاط الحمام</strong> وتركيب الشفاط المركزي مع دكت التهوية، لضمان طرد الرطوبة والروائح الكريهة بكفاءة.
 </p>
 </div>
 <div className="p-6 bg-white border border-black/5 rounded-3xl shadow-sm">
 <h3 className="font-black text-slate-900 mb-2">تهويه مركزيه مطابخ ومطاعم</h3>
 <p className="text-slate-600 text-sm leading-7">
 تأسيس و <strong>تركيب شفاط مركزي</strong> لشبكات الـ <strong>تهويه مركزيه مطابخ</strong>. نحن متخصصون في <strong>تخريم مدخنة مطعم</strong>، وعمل <strong>فتحة شفاط مطبخ مركزي</strong>، وكافة <strong>فتحات مداخن المطاعم</strong> باستخدام <strong>كور دريل مدخنة</strong> وبأفضل <strong>اسعار مداخن المطاعم</strong>.
 </p>
 </div>
 <div className="p-6 bg-slate-800 text-white rounded-3xl shadow-lg border border-slate-700">
 <h3 className="font-black text-orange-400 mb-2">شفاطات مصانع وبلاورات صناعية</h3>
 <p className="text-slate-300 text-sm leading-7">
 نقوم بتوريد وتركيب <strong>شفاط بلاور</strong> و <strong>مروحة طرد مركزي</strong> لتأسيس <strong>شفاطات مصانع</strong>. نستطيع توفير <strong>مراوح شفط كبيرة</strong> مع توضيح شفاف لـ <strong>اسعار بلاور الهواء</strong> حسب قدرة السحب وحجم المشروع.
 </p>
 </div>
 ...
 وفقاً لمواصفات الأمان لشركات الغاز، نقوم بعمل ثقب الكور المناسب لـ <strong>تركيب مدخنة سخان غاز</strong> وتوصيل الهواية الخارجية بشكل دقيق ومرتب.
  ...
  <Section
  id="preparation"
  title="تأسيس شفاط المطبخ وتركيب المداخن الخارجية"
  subtitle="التأسيس الصحيح قبل التشطيب هو سر كفاءة الشفاط"
  >
  <div className="space-y-6">
  <p>
  إن عملية <strong>تأسيس شفاط مطبخ</strong> بشكل صحيح هي الخطوة الأهم لضمان عدم وجود مشاكل مستقبلية. 
  الكثير يبحث عن <strong>تركيب مدخنة شفاط مطبخ</strong> بعد الانتهاء من السيراميك، مما قد يسبب تحديات. 
  لدينا في كور برو نستخدم ماكينة الكور لعمل الفتحة الخارجية بدقة بدون أي تكسير عشوائي، 
  ثم نقوم بتركيب الدكت (الماسورة المرنة أو الصلبة) وتوصيلها بالهواية الخارجية لمنع دخول الحشرات أو الطيور.
  </p>
  <div className="bg-orange-50 p-6 rounded-3xl border border-orange-100 mt-4">
  <h3 className="text-lg font-black text-slate-900 mb-2">مميزات تأسيس وتخريم الشفاط معنا:</h3>
  <ul className="list-disc pr-5 space-y-2 text-sm text-slate-700 leading-7">
  <li>نضمن لك <strong>مقاس فتحة الشفاط</strong> الدقيق؛ سواء كان <strong>مقاس فتحة شفاط المطبخ</strong> 4 أو 5 أو 6 بوصة، نستخدم الكور لعمل الفتحة بـ <strong>قطر فتحة الشفاط</strong> المثالي.</li>
  <li>إن <strong>تخريم جدار لعمل شفاط</strong> معنا يتم بدون تكسير وبأفضل <strong>اسعار تخريم الشفاطات</strong>.</li>
  <li>تركيب هواية (Grille) خارجية بآلية عدم الرجوع لمنع تيارات الهواء العكسية والروائح.</li>
  <li>عزل الفتحة بمواد مخصصة لمنع تسرب مياه الأمطار إلى داخل المطبخ.</li>
  <li>تجهيز مسار الدكت المخفي فوق السقف المعلق (الجبس بورد) إن وجد.</li>
  </ul>
  </div>
  </div>
  </Section>
  ...
  >
    <p>
      السؤال الأكثر شيوعاً قبل <strong>تركيب شفاط فريش</strong> أو توشيبا: <strong>هل أشتري شفاط بمدخنة خارجية أم افضل شفاط مطبخ بدون مدخنة (فلتر كربوني)؟</strong>
  ...
  >
    <p>
      <strong>تركيب دكت شفاط المطبخ</strong> بشكل صحيح يحدد كفاءة الشفاط. 
      نقوم بتحديد <strong>قطر ماسورة شفاط المطبخ</strong> وتجهيز <strong>هواية شفاط مطبخ</strong> خارجية لمنع الحشرات، حيث أن أي خطأ في <strong>تركيب مدخنة المطبخ</strong> يعني ضعف الشفط.
    </p>
 ...
 >
 <p>
 إلى جانب التركيب، نوفر خدمة <strong>تصليح شفاط المطبخ</strong> الشاملة وجميع ما يخص <strong>مشاكل شفاط المطبخ</strong>. سواء كان شفاطك لا يعمل، أو تشتكي من أن <strong>صوت الشفاط عالي</strong>، أو يرجع الهواء للداخل — فريقنا يحل المشكلة سريعاً.
 </p>
 <div className="mt-6 grid gap-4 md:grid-cols-2">
 {[
 { problem: "شفاط المطبخ لا يعمل", solution: "فحص الأسلاك والموتور — وإصلاح فوري وتوفير قطع غيار شفاط فريش وتوشيبا" },
 { problem: "صوت الشفاط عالي", solution: "صيانة شفاط توشيبا وفريش وتنظيف المراوح وتشحيم المحاور" },
 { problem: "رجوع روائح من الشفاط", solution: "فحص صمام عدم الرجوع وإعادة ختم الدكت" },
 { problem: "اعطال مفتاح شفاط توشيبا", solution: "تغيير مفتاح الشفاط وإصلاحه بقطع غيار أصلية" },
 ].map((item, i) => (
