...
const CANONICAL = `${DOMAIN}/concrete-cutting-sokhna`;
...
const FAQ = [
  {
    q: 'هل تعملون في تخريم الكور وقص الخرسانة في العين السخنة؟',
    a: 'نعم، نقدم الخدمتين لكافة المشاريع الكبرى والقرى السياحية في العين السخنة والجلالة. تخريم الكور لفتحات التكييف والغاز والسباكة والصرف، وقص الخرسانة بالمنشار لفتح الأبواب والشبابيك وقص الأسقف. فريقنا يصل لأي موقع في محافظة العين السخنة.',
  },
  {
  ...
  {
    q: 'ما هي أقطار فتحات الكور المتاحة في العين السخنة؟',
  ...
  {
    q: 'هل تعملون في تأسيس فتحات الغاز وفق الاشتراطات في العين السخنة؟',
    a: 'نعم، ننفذ فتحات مواسير الغاز الطبيعي بالأقطار والمواصفات المطلوبة من شركة الغاز في العين السخنة. الفتحة دائرية منتظمة تماماً تسهل على فني الغاز تمرير الماسورة وتثبيتها بأمان.',
  },
  {
    q: 'هل يمكنكم قص جدار لفتح باب في منزلي بالعين السخنة؟',
  ...
  {
    q: 'هل يتسبب العمل في غبار أو اهتزاز في منزلي بالعين السخنة؟',
  ...
  {
    q: 'هل تعملون في المباني القديمة في مراكز العين السخنة؟',
    a: 'نعم. خبرتنا تشمل التعامل مع مباني مراكز العين السخنة القديمة ذات الخرسانة المتقادمة. نُقيّم طبيعة الخرسانة أولاً ونختار السرعة المناسبة لضمان فتحة نظيفة دون تفتت المواد المحيطة.',
  },
  {
    q: 'هل يمكنكم قص سقف لعمل سلم داخلي (دوبلكس) في العين السخنة؟',
    a: 'نعم. قص السقف الخرساني لعمل فتحة السلم الداخلي من خدماتنا في العين السخنة. ننفذه بمنشار السكة الهيدروليكي مع تأمين البلوك قبل الفصل النهائي لمنع السقوط.',
  },
  {
    q: 'كيف أحجز موعداً لخدمة في العين السخنة؟',
    a: `تواصل معنا على ${PHONE} أو واتساب وأخبرنا بنوع العمل وموقعك في العين السخنة. نُرتِّب المعاينة المجانية وعرض السعر بسرعة. يمكن تنفيذ القص والتخريم في نفس الزيارة إذا كنت تحتاج الخدمتين.`,
  },
];
...
export default function AinSokhnaPage() {
  ...
  const jsonLd = [
    {
      ...
      description: 'كور برو متخصصون في تخريم الخرسانة بالكور وقص الخرسانة بالمنشار في العين السخنة — فتحات التكييف والغاز والسباكة وفتح الأبواب والشبابيك بدقة هندسية وبدون اهتزاز.',
      address: {
        '@type': 'PostalAddress',
        addressCountry: 'EG',
        addressLocality: 'Ain Sokhna',
        addressRegion: 'Ain Sokhna Governorate',
      },
      geo: { '@type': 'GeoCoordinates', latitude: 29.6015, longitude: 32.3168 },
      areaServed: ['العين السخنة', 'Ain Sokhna', ...SOKHNA_AREAS],
      priceRange: '$$',
      ...
      hasOfferCatalog: {
        '@type': 'OfferCatalog',
        name: 'خدمات تخريم وقص الخرسانة في العين السخنة',
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'تخريم الخرسانة بالكور في العين السخنة', url: `${DOMAIN}/core` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'قص الخرسانة بالمنشار في العين السخنة', url: `${DOMAIN}/saw` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'فتحات الغاز والتكييف والسباكة بالعين السخنة', url: `${DOMAIN}/core` } },
        ],
      },
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'تخريم الكور وقص الخرسانة في العين السخنة',
      serviceType: 'Concrete Core Drilling and Saw Cutting Ain Sokhna',
      provider: { '@type': 'LocalBusiness', name: BRAND, telephone: PHONE_INT, url: DOMAIN },
      areaServed: ['Ain Sokhna', 'العين السخنة', ...SOKHNA_AREAS],
      url: CANONICAL,
      description: 'تخريم الخرسانة بالكور وقص الخرسانة بالمنشار في العين السخنة — فتحات التكييف والغاز والسباكة وفتح الأبواب والشبابيك. نخدم جميع مراكز العين السخنة.',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'تخريم الكور وقص الخرسانة في العين السخنة', item: CANONICAL },
      ],
    },
    {
      '@context': 'https://schema.org',
      ...
      name: 'تخريم الخرسانة بالكور في العين السخنة',
      description: 'ماكينة كور دريل هيدروليكية أثناء تخريم سقف خرساني في العين السخنة — كور برو',
    ...
    },
    {
      ...
      '@type': 'WebPage',
      url: CANONICAL,
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['#core-sokhna', '#saw-sokhna', '#faq', 'h1'] },
    },
  ];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-10 pb-14 md:pt-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-4 py-2 text-sm text-sky-800 shadow-sm mb-6">
            ...
            <span>يخدم جميع مراكز محافظة العين السخنة · تخريم بالكور · قص بالمنشار</span>
          </div>
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div>
              <h1 className="text-3xl md:text-5xl font-black leading-tight text-slate-900 border-r-8 border-sky-600 pr-4">
                صنايعي كور وقص الخرسانة في العين السخنة - 01021507462
              </h1>
              <div className="mt-5 text-slate-800 leading-9 space-y-4 text-lg">
                <p>
                  <strong>كور برو - Core Pro</strong> هو متخصصك الأول في <strong>تخريم الخرسانة بالكور في العين السخنة</strong>
                  و<strong>قص الخرسانة بالمنشار في العين السخنة</strong>. نقدم الخدمتين بأعلى معايير الجودة —
                  بدون اهتزاز، وبدون غبار، وبضمان سلامة الهيكل الإنشائي.
                </p>
                <p>
                  سواء كنت تحتاج <strong>صنايعي كور في العين السخنة</strong> لفتحات التكييف والغاز والسباكة،
                  أو <strong>فني قص خرسانة في العين السخنة</strong> لفتح باب أو شباك أو قص سقف دوبلكس —
                  فريقنا يصل لأي موقع في العين السخنة وينجز العمل باحترافية.
                </p>
              </div>

              {/* خدمتان واضحتان */}
              <div className="mt-7 grid grid-cols-2 gap-3">
                <a href="#core-sokhna" className="flex flex-col items-center gap-2 rounded-2xl border-2 border-sky-400 bg-sky-50 px-4 py-4 text-sm text-slate-800 shadow-sm font-bold text-center hover:bg-sky-100 transition">
                  <Ruler className="h-6 w-6 text-sky-600" />
                  تخريم بالكور
                  <span className="text-xs text-slate-500 font-medium">تكييف · غاز · سباكة · صرف</span>
                </a>
                <a href="#saw-sokhna" className="flex flex-col items-center gap-2 rounded-2xl border-2 border-amber-400 bg-amber-50 px-4 py-4 text-sm text-slate-800 shadow-sm font-bold text-center hover:bg-amber-100 transition">
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-slate-500">
                ...
                <span>معاينة مجانية · نصل لجميع مراكز العين السخنة</span>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-black/10 bg-white/80 backdrop-blur-xl shadow-[0_16px_60px_rgba(0,0,0,0.1)] p-7 space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-black text-slate-900 text-lg">تغطية محافظة العين السخنة</div>
                  <div className="text-sm text-slate-500">جميع المراكز والمدن</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2">
                {SOKHNA_AREAS.map(area => (
      ...
      <div className="mx-auto max-w-6xl px-4 pb-24">
        <div className="grid gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-10 min-w-0">
            ...
            <Section id="core-sokhna" title="تخريم الخرسانة بالكور في العين السخنة (الخدمة الرئيسية)">
              <p>
                <strong>تخريم الخرسانة بالكور في العين السخنة</strong> هو تخصصنا الأبرز ويُمثل الطلب الأكثر في المنطقة.
              ...
              <div className="not-prose space-y-4 mt-6">
                <h3 className="text-xl font-black text-slate-900">أنواع فتحات الكور في العين السخنة:</h3>
                {[
                  { t: 'فتحة التكييف الاسبليت والمركزي', d: 'قطر 5-8 سم بميل مضبوط للخارج. الأكثر طلباً في العين السخنة. ننفذها بدقة لضمان خروج مياه التكثيف بشكل صحيح.', icon: Wind },
              ...
              <div className="not-prose mt-6">
                <h3 className="text-lg font-black text-slate-900 mb-4">دليل الأقطار الشائعة في العين السخنة:</h3>
              ...
              <div className="not-prose mt-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                <Image src="/images/core/fatahat-core-beton-1.webp" alt="تخريم الخرسانة بالكور في العين السخنة" width={800} height={533} className="w-full object-cover" loading="lazy" />
                <div className="bg-white px-4 py-2 text-xs text-slate-500">ماكينة كور دريل هيدروليكية أثناء تخريم سقف خرساني — كور برو العين السخنة</div>
              </div>
            </Section>

            {/* 2. قص المنشار - SECONDARY */}
            <Section id="saw-sokhna" title="قص الخرسانة بالمنشار في العين السخنة — فتح الأبواب والشبابيك والأسقف">
              <p>
                إلى جانب تخريم الكور، نقدم أيضاً <strong>قص الخرسانة بالمنشار في العين السخنة</strong>
            ...
            {/* 3. مراحل التنفيذ */}
            <Section id="process" title="مراحل التنفيذ في العين السخنة: من التواصل إلى التسليم">
              <div className="space-y-5 not-prose">
                {[
                  { n: '1', t: 'التواصل وتحديد نوع العمل', d: `تتصل بنا على ${PHONE} أو واتساب وتُخبرنا بالعمل المطلوب (تخريم أو قص أو كلاهما) وموقعك في العين السخنة.` },
            ...
            {/* 4. FAQ */}
            <Section id="faq" title="الأسئلة الشائعة عن تخريم الكور وقص الخرسانة في العين السخنة">
          ...
          <aside className="space-y-6 min-w-0">
            ...
            <div className="p-7 rounded-[40px] bg-white border border-black/10 shadow-lg">
              <h3 className="font-black text-xl text-slate-900 mb-5">لماذا كور برو بالعين السخنة؟</h3>
              <div className="space-y-4">
                ...
                <StatPill icon={<MapPin className="h-4 w-4 text-rose-500" />} text="تغطية محافظة العين السخنة كاملة" />
            ...
            <div className="p-6 rounded-[40px] bg-slate-900 text-white shadow-lg">
              <h3 className="font-black text-lg mb-4 flex items-center gap-2">
                ...
                مراكز العين السخنة التي نخدمها
              </h3>
              <div className="space-y-2">
                {SOKHNA_AREAS.map(area => (
          ...
          <div className="relative z-10 p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-500/20 text-sky-300 font-bold mb-5 text-sm border border-sky-500/30">
                ...
                تخريم الكور وقص الخرسانة في العين السخنة
              </div>
              <h2 className="text-2xl md:text-4xl font-black mb-4 leading-tight">جاهز لبدء مشروعك في العين السخنة؟</h2>
              <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                تواصل معنا الآن للحصول على معاينة مجانية وعرض سعر فوري. فريقنا جاهز لخدمتك في العين السخنة 7 أيام أسبوعياً.
              </p>
