...
const jsonLd = [
 ...
 description: "كور برو - Core Pro شركة مصرية متخصصة في قص الخرسانة بالمنشار وتخريم الكور وتركيب الشفاطات بالقاهرة الكبرى والجيزة.",
 address: {
 "@type": "PostalAddress",
 addressCountry: "EG",
...
export default function AboutPage() {
 ...
 <span> خبرة ميدانية واسعة · معدات حديثة · ضمان الجودة</span>
 </div>
 <h1 className="text-3xl md:text-5xl font-black leading-tight text-slate-900 border-r-8 border-emerald-600 pr-4 text-right">
 من نحن | كور برو - Core Pro - متخصصون في قص وتخريم الخرسانة بمصر
 </h1>
 <p className="mt-6 text-slate-700 leading-9 text-lg text-right">
 نحن في <strong>كور برو - Core Pro</strong> شركة مصرية متخصصة تجمع بين أربع خدمات أساسية في فريق واحد:{" "}
 ...
 قصتنا: لماذا أسسنا كور برو - Core Pro؟
 </h2>
 ...
 <p>
 أنشأنا <strong>كور برو - Core Pro</strong> لنكون الحل الكامل: فريق واحد يمتلك المعدات والخبرة الميدانية لإنجاز
