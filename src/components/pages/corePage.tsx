          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h1 className="mt-4 text-3xl md:text-5xl font-black leading-tight text-slate-900 border-r-8 border-emerald-600 pr-4">
                فتحات كور في الخرسانة — الحل الهندسي الأمثل لتأسيس مرافق منزلك بدقة جراحية وبدون اهتزاز
              </h1>

              <div className="mt-5 text-slate-800 leading-9 text-lg space-y-4">
                <p>
                  <strong>فتحات كور</strong> هي الحل الهندسي الأمثل لإحداث فجوات أسطوانية نظيفة في الخرسانة بدون تكسير أو اهتزاز. نحن نتخصص في عمل <strong>فتحات كور</strong> احترافية باستخدام أحدث ماكينات التخريم لضمان سلامة الهيكل الإنشائي ودقة القياسات بالمليمتر. سواء كنت تحتاج <strong>فتحات كور الغاز</strong>، أو <strong>فتحات كور التكييف</strong>، أو فتحات مواسير السباكة — فريقنا ينجز كل مهمة بسرعة ونظافة تامة.
                </p>
                <p>
            ...
            <div className="rounded-none border-4 border-white bg-white shadow-2xl overflow-hidden p-4 relative">
              ...
              >
                <Image src={IMG_HERO} alt="تخريم الخرسانة بالكور - Core Pro Egypt" fill priority className="object-cover group-hover:scale-105 transition-transform duration-500 rounded-none" />
      ...
      <div className="mx-auto max-w-6xl px-4 pb-24">
        <div className="grid gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-10">
            ...
            >
              <p>
                التكسير باستخدام آلات الدق الميكانيكية يولد اهتزازات عنيفة تؤدي إلى شروخ مجهرية (Micro-cracks) تضعف المبنى بمرور الوقت وتسبب تساقط المحارة. في المقابل، <strong>عمل فتحات بالكور</strong> يعتمد على القطع الدائري السلس الذي يفصل الخرسانة والحديد بحركة هادئة لا تُحدث أي ارتدادات للهيكل المحيط.
              </p>
              <p className="mt-4">
