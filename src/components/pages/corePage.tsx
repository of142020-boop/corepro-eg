...
export default function CorePage() {
 ...
 {
 q: "ما هي تكلفة عمل فتحة كور في مصر؟",
 a: "تختلف تكلفة عمل فتحة كور بناءً على قطر الفتحة، وسماكة الجدار أو السقف الخرساني، وطبيعة الخرسانة. نقدم أسعاراً تنافسية جداً وعروضاً خاصة للكميات. اتصل بنا لمعاينة مجانية وتحديد التكلفة بدقة.",
 },
 {
 q: "هل تتعاقدون مع شركات تخريم الخرسانة للمشاريع الكبيرة؟",
 a: "نعم، كور برو هي الشريك المثالي لشركات المقاولات وتخريم الخرسانة، حيث نوفر أسطولاً من المعدات والعمالة الماهرة لإنجاز المشاريع الضخمة والكمبوندات بأسرع وقت.",
 },
 ];
 ...
 {
 "@type": "Question",
 name: "ما هي تكلفة عمل فتحة كور في مصر؟",
 acceptedAnswer: {
 "@type": "Answer",
 text: "تختلف تكلفة عمل فتحة كور بناءً على قطر الفتحة، وسماكة الجدار أو السقف الخرساني، وطبيعة الخرسانة. نقدم أسعاراً تنافسية جداً وعروضاً خاصة للكميات. اتصل بنا لمعاينة مجانية وتحديد التكلفة بدقة.",
 },
 },
 {
 "@type": "Question",
 name: "هل تتعاقدون مع شركات تخريم الخرسانة للمشاريع الكبيرة؟",
 acceptedAnswer: {
 "@type": "Answer",
 text: "نعم، كور برو هي الشريك المثالي لشركات المقاولات وتخريم الخرسانة، حيث نوفر أسطولاً من المعدات والعمالة الماهرة لإنجاز المشاريع الضخمة والكمبوندات بأسرع وقت.",
 },
 },
 ],
 };
 ...
 أفضل صنايعي وفني كور لعمل أي فتحة كور وتخريم جدار خرساني - 01021507462
 </h1>

 <div className="mt-5 text-slate-800 leading-9 text-lg space-y-4">
 <p>
 تبحث عن <strong>صنايعي كور</strong> أو <strong>فني كور</strong> محترف؟ <strong>فتحات كور</strong> — وتُعرف أيضاً بـ <strong>فتحة كور</strong> الواحدة — هي الحل الهندسي الأمثل لإحداث فجوات أسطوانية نظيفة في الخرسانة بدون تكسير أو اهتزاز. كأفضل <strong>صنايعي كور في مصر</strong>، نتخصص في عمل <strong>فتحات كور</strong> احترافية باستخدام أحدث ماكينات التخريم والأسطوانات الماسية (<strong>كور ماسي</strong>) لضمان سلامة الهيكل الإنشائي ودقة القياسات بالمليمتر. سواء كنت تحتاج <strong>صنايعي كور</strong> أو <strong>صنايعي تخريم</strong> لتمرير مواسير الغاز أو التكييف أو السباكة — فريقنا ينجز كل مهمة بسرعة ونظافة تامة.
 </p>
 <p>
 سواء كنت تحتاج إلى <strong>صنايعي كور</strong> لعمل فتحات في الخرسانة لتمرير مواسير السباكة، أو تجهيز مسارات التكييف المركزي، أو حتى تخريم الخرسانة المسلحة لعمل تعديلات معمارية كبرى، فإننا نوفر لك أمهر <strong>صنايعي الكور</strong> وأكفأ <strong>عمال كور</strong> في مصر. باستخدام <strong>دريل تخريم</strong> متطور وأحدث أسطوانات <strong>كور ماسي</strong>، نضع بين يديك خبرتنا لتنفيذ <strong>فتحات كور خرسانة</strong> بأعلى دقة وأسرع وقت. كما نُعد الشريك الهندسي المفضل لـ <strong>شركات تخريم الخرسانة</strong> والمقاولات في مصر.
 </p>
 </div>
 ...
 >
 <p>
 السر الحقيقي وراء جودة التنفيذ ونظافة الفتحة يكمن في استخدام <strong>ماكينة كور تخريم الخرسانة</strong> الحديثة. هذه الماكينات، والمعروفة مهنياً باسم <strong>ماكينة الكور</strong>، مزودة برؤوس أسطوانية — تُعرف بـ <strong>اسطوانة كور</strong> أو <strong>رأس كور ماسي</strong> — مطلية بحبيبات الألماس الصناعي القادرة على اختراق أصلب أنواع الخرسانات كثيفة التسليح. تضمن لك أي <strong>ماكينة تخريم خرسانة</strong> نستخدمها الحصول على <strong>فتحة الكور</strong> ناعمة تماماً من الداخل، مما يمنع احتكاك الكابلات أو المواسير عند تمريرها لاحقاً.
 </p>
 </Section>
 ...
 <div className="mt-4 bg-amber-50 border border-amber-200 rounded-2xl p-4 text-sm text-slate-700 leading-7">
   ⚠️ <strong>تنبيه السلامة:</strong> فتحة مدخنة السخان تحتاج قطراً وزاوية ميل دقيقين — أي خطأ يُعرّض الأسرة لخطر الاختناق. نحن نطبّق معايير الجهاز القومي للغاز في كل عمل ننفذه.
 </div>
 </div>
 <div>
 <h3 className="text-xl font-black text-slate-900 mb-2">3. فتح كور في الكمر وتخريم السقف بأمان</h3>
 <p>
 التعديلات الإنشائية المتأخرة تتطلب حذراً شديداً من فريق التنفيذ. عند الحاجة إلى <strong>تخريم السقف</strong> لتمرير الصرف الصحي أو صرف التكييف، نمتلك الحل السحري؛ حيث يمكننا <strong>تخريم كمر</strong> (<strong>فتح كور في الكمر</strong>) الخرساني بقطر محسوب بدقة، وكذلك <strong>تخريم جدار خرساني</strong> بالكامل دون إحداث ضرر بأسياخ حديد التسليح الرئيسي المكون للكمرة.
 </p>
 <p className="mt-2">
 ...
 <div>
 <h3 className="text-xl font-black text-slate-900 mb-2">4. تخريم بلاطة الأرضيات والأسقف (قبل وبعد التشطيب)</h3>
 <p>
 <strong>تخريم بلاطة</strong> الأرضيات الخرسانية القائمة من أكثر المهام دقةً وحساسيةً — سواء لتمرير مواسير الصرف الجديدة في شقة مشطّبة، أو لتأسيس وصلات المياه في الأدوار العلوية. نستخدم <strong>صنايعي كور</strong> متخصصين وماكينات بتبريد مائي مستمر لضمان <strong>تخريم بلاطة</strong> نظيف بدون أي شروخ أو كسر في البلاطات المجاورة. هذه الخدمة متاحة للبلاطة الخرسانية العادية، والخرسانة المسلحة، والبلاطات فوق البدروم. نتخصص أيضاً في <strong>عمل فتحة صرف في البلاطة</strong> للمطابخ والحمامات المشطّبة — حيث نُنجز <strong>ثقب خرسانة</strong> نظيف بدون أي تلف في التشطيبات المحيطة.
 </p>
 </div>
 </div>
 </Section>
 ...
 <p className="mb-4">يتم تحديد <strong>سعر فتحات الكور</strong> (أو <strong>تكلفة عمل فتحة كور</strong> الواحد) — ويُعرف أيضاً بـ <strong>سعر تخريم الخرسانة</strong> — بناءً على عدة عوامل هندسية:</p>
 ...
 نوفر لك <strong>خدمة كور</strong> متكاملة بـ<strong>أفضل اسعار فتحات الكور</strong> وأسرع <strong>صنايعي كور</strong> في مصر مع التزام تام بالمواعيد والجودة الهندسية.
 </p>
 <div className="space-y-4">
 ...
 <p className="text-emerald-100 text-sm mb-6 leading-7">سيقوم فريقنا بالرد عليك فوراً وتحديد التكلفة المبدئية وإرسال <strong>فني كور</strong> متخصص لموقعك.</p>
 <Link
 href={WHATSAPP}
