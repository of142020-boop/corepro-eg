...
export default function CorePage() {
 ...
 <p>
 سواء كنت تحتاج إلى <strong>صنايعي كور</strong> لعمل فتحات في الخرسانة لتمرير مواسير السباكة، أو تجهيز مسارات التكييف المركزي، أو حتى تخريم الخرسانة المسلحة لعمل تعديلات معمارية كبرى، فإننا نوفر لك أمهر <strong>صنايعي الكور</strong> وأكفأ <strong>عمال كور</strong> في مصر. نضع بين يديك خبرتنا ومعداتنا لتنفيذ <strong>فتحات كور خرسانة</strong> بأعلى دقة، أسرع وقت، وبأقل نسبة هدر للتشطيبات.
 </p>
 </div>
 ...
 <p className="mb-4">يتم تحديد <strong>سعر فتحات الكور</strong> أو <strong>سعر فتحة الكور</strong> الواحد — ويُعرف أيضاً بـ <strong>سعر تخريم الخرسانة</strong> — بناءً على:</p>
