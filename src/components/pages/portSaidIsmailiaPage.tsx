...
const CANONICAL = `${DOMAIN}/concrete-cutting-port-said-ismailia`;
const PHONE     = '01021507462';
const PHONE_INT = '+201021507462';
const WHATSAPP  = 'https://wa.me/201021507462';

const PORTSAID_AREAS = [
  'ميناء شرق بورسعيد',
  'المنطقة الحرة الاستثمارية',
  'مدينة الإسماعيلية الجديدة',
  'قناة السويس ومحيطها',
  'القنطرة وشرق التفريعة',
  'المناطق الصناعية'
];

const FAQ = [
  {
    q: 'هل تعملون في قص الخرسانة بالواير وتخريم الكور لمشاريع القناة؟',
    a: 'نعم، نقدم خدماتنا لكبرى المشاريع في مدن القناة والموانئ، مع تخصص دقيق في قص الكتل الخرسانية الضخمة بالواير الماسي. تخريم الكور لفتحات التكييف والغاز والسباكة والصرف، وقص الخرسانة بالمنشار لفتح الأبواب والشبابيك وقص الأسقف. فريقنا يصل لأي موقع في محافظة بورسعيد والإسماعيلية.',
  },
  {
  ...
  {
    q: 'ما هي أقطار فتحات الكور المتاحة في بورسعيد والإسماعيلية؟',
  ...
  {
    q: 'هل تعملون في تأسيس فتحات الغاز وفق الاشتراطات في بورسعيد والإسماعيلية؟',
    a: 'نعم، ننفذ فتحات مواسير الغاز الطبيعي بالأقطار والمواصفات المطلوبة من شركة الغاز في بورسعيد والإسماعيلية. الفتحة دائرية منتظمة تماماً تسهل على فني الغاز تمرير الماسورة وتثبيتها بأمان.',
  },
  {
    q: 'كيف يفيد القص بالواير مشاريع البنية التحتية في بورسعيد؟',
    a: 'تقنية الواير الماسي مثالية للمشاريع القومية، حيث يمكننا فصل أجزاء كباري كاملة أو قص قواعد أرصفة الموانئ بدقة هندسية متناهية وفي وقت قياسي مقارنة بطرق التكسير التقليدية.',
  },
  {
    q: 'هل يتسبب العمل في غبار أو اهتزاز في منزلي ببورسعيد والإسماعيلية؟',
  ...
  {
    q: 'هل تعملون في المباني القديمة في مراكز بورسعيد والإسماعيلية؟',
    a: 'نعم. خبرتنا تشمل التعامل مع مباني مراكز بورسعيد والإسماعيلية القديمة ذات الخرسانة المتقادمة. نُقيّم طبيعة الخرسانة أولاً ونختار السرعة المناسبة لضمان فتحة نظيفة دون تفتت المواد المحيطة.',
  },
  {
    q: 'هل يمكنكم قص سقف لعمل سلم داخلي (دوبلكس) في بورسعيد والإسماعيلية؟',
    a: 'نعم. قص السقف الخرساني لعمل فتحة السلم الداخلي من خدماتنا في بورسعيد والإسماعيلية. ننفذه بمنشار السكة الهيدروليكي مع تأمين البلوك قبل الفصل النهائي لمنع السقوط.',
  },
  {
    q: 'كيف أحجز موعداً لخدمة في بورسعيد والإسماعيلية؟',
    a: `تواصل معنا على ${PHONE} أو واتساب وأخبرنا بنوع العمل وموقعك في بورسعيد والإسماعيلية. نُرتِّب المعاينة المجانية وعرض السعر بسرعة. يمكن تنفيذ القص والتخريم في نفس الزيارة إذا كنت تحتاج الخدمتين.`,
  },
];
...
export default function PortSaidIsmailiaPage() {
  ...
  const jsonLd = [
    {
      ...
      description: 'كور برو المقاول الأول لأعمال قص الخرسانة بالواير الماسي (Wire Sawing) وتخريم الكور في بورسعيد والإسماعيلية. متخصصون في قص الكباري والموانئ والمشاريع القومية.',
      address: {
        '@type': 'PostalAddress',
        addressCountry: 'EG',
        addressLocality: 'Port Said & Ismailia',
        addressRegion: 'Port Said & Ismailia Governorate',
      },
      geo: { '@type': 'GeoCoordinates', latitude: 31.2565, longitude: 32.2841 },
      areaServed: ['بورسعيد والإسماعيلية', 'Port Said & Ismailia', ...PORTSAID_AREAS],
      priceRange: '$$',
      ...
      hasOfferCatalog: {
        '@type': 'OfferCatalog',
        name: 'خدمات تخريم وقص الخرسانة في بورسعيد والإسماعيلية',
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'تخريم الخرسانة بالكور في بورسعيد والإسماعيلية', url: `${DOMAIN}/core` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'قص الخرسانة بالمنشار في بورسعيد والإسماعيلية', url: `${DOMAIN}/saw` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'فتحات الغاز والتكييف والسباكة ببورسعيد والإسماعيلية', url: `${DOMAIN}/core` } },
        ],
      },
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'قص الخرسانة بالواير وتخريم الكور لمشاريع القناة',
      serviceType: 'Concrete Core Drilling and Saw Cutting Port Said & Ismailia',
      provider: { '@type': 'LocalBusiness', name: BRAND, telephone: PHONE_INT, url: DOMAIN },
      areaServed: ['Port Said & Ismailia', 'بورسعيد والإسماعيلية', ...PORTSAID_AREAS],
      url: CANONICAL,
      description: 'تخريم الخرسانة بالكور وقص الخرسانة بالمنشار في بورسعيد والإسماعيلية — فتحات التكييف والغاز والسباكة وفتح الأبواب والشبابيك. نخدم جميع مراكز بورسعيد والإسماعيلية.',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'قص الخرسانة بالواير وتخريم الكور لمشاريع القناة', item: CANONICAL },
      ],
    },
    {
      '@context': 'https://schema.org',
      ...
      name: 'تخريم الخرسانة بالكور في بورسعيد والإسماعيلية',
      description: 'ماكينة كور دريل هيدروليكية أثناء تخريم سقف خرساني في بورسعيد والإسماعيلية — كور برو',
    ...
    },
    {
      ...
      '@type': 'WebPage',
      url: CANONICAL,
      speakable: { '@type': 'SpeakableSpecification', cssSelector: ['#core-port-said-ismailia', '#saw-port-said-ismailia', '#faq', 'h1'] },
    },
  ];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-10 pb-14 md:pt-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-4 py-2 text-sm text-sky-800 shadow-sm mb-6">
            ...
            <span>يخدم جميع مراكز محافظة بورسعيد والإسماعيلية · تخريم بالكور · قص بالمنشار</span>
          </div>
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div>
              <h1 className="text-3xl md:text-5xl font-black leading-tight text-slate-900 border-r-8 border-sky-600 pr-4">
                صنايعي كور وقص الخرسانة في بورسعيد والإسماعيلية - 01021507462
              </h1>
              <div className="mt-5 text-slate-800 leading-9 space-y-4 text-lg">
                <p>
                  <strong>كور برو - Core Pro</strong> هو متخصصك الأول في <strong>تخريم الخرسانة بالكور في بورسعيد والإسماعيلية</strong>
                  و<strong>قص الخرسانة بالمنشار في بورسعيد والإسماعيلية</strong>. نقدم الخدمتين بأعلى معايير الجودة —
                  بدون اهتزاز، وبدون غبار، وبضمان سلامة الهيكل الإنشائي.
                </p>
                <p>
                  سواء كنت تحتاج <strong>صنايعي كور في بورسعيد والإسماعيلية</strong> لفتحات التكييف والغاز والسباكة،
                  أو <strong>فني قص خرسانة في بورسعيد والإسماعيلية</strong> لفتح باب أو شباك أو قص سقف دوبلكس —
                  فريقنا يصل لأي موقع في بورسعيد والإسماعيلية وينجز العمل باحترافية.
                </p>
              </div>

              {/* خدمتان واضحتان */}
              <div className="mt-7 grid grid-cols-2 gap-3">
                <a href="#core-port-said-ismailia" className="flex flex-col items-center gap-2 rounded-2xl border-2 border-sky-400 bg-sky-50 px-4 py-4 text-sm text-slate-800 shadow-sm font-bold text-center hover:bg-sky-100 transition">
                  <Ruler className="h-6 w-6 text-sky-600" />
                  تخريم بالكور
                  <span className="text-xs text-slate-500 font-medium">تكييف · غاز · سباكة · صرف</span>
                </a>
                <a href="#saw-port-said-ismailia" className="flex flex-col items-center gap-2 rounded-2xl border-2 border-amber-400 bg-amber-50 px-4 py-4 text-sm text-slate-800 shadow-sm font-bold text-center hover:bg-amber-100 transition">
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-slate-500">
                ...
                <span>معاينة مجانية · نصل لجميع مراكز بورسعيد والإسماعيلية</span>
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-black/10 bg-white/80 backdrop-blur-xl shadow-[0_16px_60px_rgba(0,0,0,0.1)] p-7 space-y-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-black text-slate-900 text-lg">تغطية محافظة بورسعيد والإسماعيلية</div>
                  <div className="text-sm text-slate-500">جميع المراكز والمدن</div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-2">
                {PORTSAID_AREAS.map(area => (
      ...
      <div className="mx-auto max-w-6xl px-4 pb-24">
        <div className="grid gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-10 min-w-0">
            ...
            <Section id="core-port-said-ismailia" title="تخريم الخرسانة بالكور في بورسعيد والإسماعيلية (الخدمة الرئيسية)">
              <p>
                <strong>تخريم الخرسانة بالكور في بورسعيد والإسماعيلية</strong> هو تخصصنا الأبرز ويُمثل الطلب الأكثر في المنطقة.
              ...
              <div className="not-prose space-y-4 mt-6">
                <h3 className="text-xl font-black text-slate-900">أنواع فتحات الكور في بورسعيد والإسماعيلية:</h3>
                {[
                  { t: 'فتحة التكييف الاسبليت والمركزي', d: 'قطر 5-8 سم بميل مضبوط للخارج. الأكثر طلباً في بورسعيد والإسماعيلية. ننفذها بدقة لضمان خروج مياه التكثيف بشكل صحيح.', icon: Wind },
              ...
              <div className="not-prose mt-6">
                <h3 className="text-lg font-black text-slate-900 mb-4">دليل الأقطار الشائعة في بورسعيد والإسماعيلية:</h3>
              ...
              <div className="not-prose mt-6 rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                <Image src="/images/core/fatahat-core-beton-1.webp" alt="تخريم الخرسانة بالكور في بورسعيد والإسماعيلية" width={800} height={533} className="w-full object-cover" loading="lazy" />
                <div className="bg-white px-4 py-2 text-xs text-slate-500">ماكينة كور دريل هيدروليكية أثناء تخريم سقف خرساني — كور برو بورسعيد والإسماعيلية</div>
              </div>
            </Section>

            {/* 2. قص المنشار - SECONDARY */}
            <Section id="saw-port-said-ismailia" title="قص الخرسانة بالمنشار في بورسعيد والإسماعيلية — فتح الأبواب والشبابيك والأسقف">
              <p>
                إلى جانب تخريم الكور، نقدم أيضاً <strong>قص الخرسانة بالمنشار في بورسعيد والإسماعيلية</strong>
            ...
            {/* 3. مراحل التنفيذ */}
            <Section id="process" title="مراحل التنفيذ في بورسعيد والإسماعيلية: من التواصل إلى التسليم">
              <div className="space-y-5 not-prose">
                {[
                  { n: '1', t: 'التواصل وتحديد نوع العمل', d: `تتصل بنا على ${PHONE} أو واتساب وتُخبرنا بالعمل المطلوب (تخريم أو قص أو كلاهما) وموقعك في بورسعيد والإسماعيلية.` },
            ...
            {/* 4. FAQ */}
            <Section id="faq" title="الأسئلة الشائعة عن قص الخرسانة بالواير وتخريم الكور لمشاريع القناة">
          ...
          <aside className="space-y-6 min-w-0">
            ...
            <div className="p-7 rounded-[40px] bg-white border border-black/10 shadow-lg">
              <h3 className="font-black text-xl text-slate-900 mb-5">لماذا كور برو ببورسعيد والإسماعيلية؟</h3>
              <div className="space-y-4">
                ...
                <StatPill icon={<MapPin className="h-4 w-4 text-rose-500" />} text="تغطية محافظة بورسعيد والإسماعيلية كاملة" />
            ...
            <div className="p-6 rounded-[40px] bg-slate-900 text-white shadow-lg">
              <h3 className="font-black text-lg mb-4 flex items-center gap-2">
                ...
                مراكز بورسعيد والإسماعيلية التي نخدمها
              </h3>
              <div className="space-y-2">
                {PORTSAID_AREAS.map(area => (
          ...
          <div className="relative z-10 p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-500/20 text-sky-300 font-bold mb-5 text-sm border border-sky-500/30">
                ...
                قص الخرسانة بالواير وتخريم الكور لمشاريع القناة
              </div>
              <h2 className="text-2xl md:text-4xl font-black mb-4 leading-tight">جاهز لبدء مشروعك في بورسعيد والإسماعيلية؟</h2>
              <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                تواصل معنا الآن للحصول على معاينة مجانية وعرض سعر فوري. فريقنا جاهز لخدمتك في بورسعيد والإسماعيلية 7 أيام أسبوعياً.
              </p>
