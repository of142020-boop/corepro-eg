...
const ALX_AREAS = [
  ...
  'وسط الإسكندرية والكورنيش',
];

const FAQ = [
  {
    q: 'هل تعملون في الإسكندرية بشكل دائم وليس موسمياً؟',
    a: 'نعم، لدينا فريق متخصص يغطي الإسكندرية بشكل كامل ودائم طوال العام. نخدم جميع أحياء الإسكندرية من المنتزه شرقاً حتى العجمي والدخيلة غرباً ونصل لموقعك في أسرع وقت ممكن.',
  },
  {
    q: 'هل تختلف أسعار قص الخرسانة في الإسكندرية عن القاهرة؟',
  ...
  {
    q: 'هل تعملون في المباني القديمة والكلاسيكية في وسط الإسكندرية؟',
    a: 'نعم، ولدينا خبرة خاصة في التعامل مع خرسانة المباني القديمة والعمائر الكلاسيكية في الإسكندرية. نقوم بمعاينة دقيقة لتحديد طبيعة الخرسانة ومستوى التسليح أولاً، مما يضمن تنفيذ العمل بأمان دون المساس بسلامة الهيكل الإنشائي القديم.',
  },
  {
    q: 'هل تؤثر رطوبة وملوحة هواء الإسكندرية على جودة العمل؟',
  ...
  {
    q: 'كم تستغرق عملية قص جدار كامل لفتح باب في الإسكندرية؟',
  ...
  {
    q: 'هل عملية التخريم بالكور في الإسكندرية نظيفة للشقق المفروشة؟',
    a: 'نعم تماماً. نعتمد على نظام التبريد المائي (Wet Core Drilling) الذي يحوّل الغبار إلى معجون سائل يُسحب فوراً. لا يتصاعد أي غبار في الهواء، مما يجعل العملية مثالية للشقق المسكونة والمفروشة في الإسكندرية.',
  },
  {
  ...
  {
    q: 'ما الفرق بين قص الخرسانة بالمنشار والتكسير بالصاروخ في الإسكندرية؟',
    a: 'التكسير بالصاروخ العادي يُحدث اهتزازات تُشقق الجدران المجاورة وقد تُضعف الأعمدة والأساسات — خاصة في مباني الإسكندرية القديمة ذات الخرسانة الهشة. أما القص بالمنشار الماسي فيعتمد على القطع السلس دون اهتزاز واحد، مما يضمن سلامة المبنى بنسبة 100%.',
  },
  {
    q: 'هل تقدمون ضماناً على جودة العمل في الإسكندرية؟',
    a: 'نعم. نقف خلف كل عمل ننفذه. إذا ظهرت أي مشكلة ناتجة عن تنفيذنا، نعود لموقعك في الإسكندرية فوراً لمعالجتها دون تكاليف إضافية. سمعتنا هي رأس مالنا الأول.',
  },
];
  ...
  const jsonLd = [
    {
      ...
      description: 'كور برو - Core Pro متخصصون في قص الخرسانة بالمنشار وتخريم الكور وتركيب الشفاطات بالإسكندرية بدقة هندسية وأمان كامل.',
      address: {
        '@type': 'PostalAddress',
        addressCountry: 'EG',
      ...
      areaServed: ['الإسكندرية', 'Alexandria', ...ALX_AREAS],
      priceRange: '$$',
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'قص خرسانة الإسكندرية بالمنشار', url: `${DOMAIN}/saw` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'تخريم الخرسانة بالكور في الإسكندرية', url: `${DOMAIN}/core` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'تركيب شفاطات المطابخ بالإسكندرية', url: `${DOMAIN}/hoods` } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'قص الخرسانة بالواير الماسي بالإسكندرية', url: `${DOMAIN}/wire` } },
        ],
      },
    },
    {
      '@context': 'https://schema.org',
      '@type': 'Service',
      name: 'قص وتخريم الخرسانة بالإسكندرية',
      serviceType: 'Concrete Cutting and Core Drilling Alexandria',
      provider: { '@type': 'LocalBusiness', name: BRAND, telephone: PHONE_INT, url: DOMAIN },
      areaServed: ['Alexandria', 'الإسكندرية', ...ALX_AREAS],
      url: CANONICAL,
      description: 'خدمات متكاملة لقص الخرسانة بالمنشار وتخريم الكور وتركيب الشفاطات في الإسكندرية. نخدم جميع أحياء الإسكندرية بمعدات حديثة وبدون اهتزازات.',
    },
    {
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pt-10 pb-14 md:pt-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-4 py-2 text-sm text-sky-800 shadow-sm mb-6">
            ...
            <span>يخدم جميع أحياء الإسكندرية · قص · تخريم · شفاطات · واير</span>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
            <div>
              ...
              <div className="mt-5 text-slate-800 leading-9 space-y-4 text-lg">
                <p>
                  <strong>كور برو - Core Pro</strong> هو متخصصك الأول في <strong>قص الخرسانة بالإسكندرية</strong> وتخريم الكور وتركيب الشفاطات.
                  نقدم خدماتنا لأهالي الإسكندرية في كافة الأحياء بأحدث معدات القطع الماسي والتخريم الهيدروليكي —
                  <strong> بدون اهتزازات، وبدون غبار، وبضمان سلامة الهيكل الإنشائي.</strong>
                </p>
                <p>
                  سواء كنت تحتاج <strong>معلم قص جدار بالإسكندرية</strong> لفتح باب أو شباك، أو <strong>صنايعي كور اسكندرية</strong> لتمرير مواسير الغاز والتكييف،
                  أو <strong>فني تركيب شفاط مطبخ بالإسكندرية</strong> — فريقنا المتخصص يصل إليك ويُنجز المهمة بسرعة ودقة عالية.
                </p>
              </div>
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-slate-500">
                ...
                <span>معاينة مجانية · نصل خلال 24 ساعة في الإسكندرية</span>
              </div>
            </div>
      ...
      <div className="mx-auto max-w-6xl px-4 pb-24">
        <div className="grid gap-10 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-10 min-w-0">
            ...
            <Section id="saw-alexandria" title="قص الخرسانة بالمنشار في الإسكندرية">
              <p>
                تقنية <strong>قص الخرسانة بالمنشار في الإسكندرية</strong> هي الحل الهندسي الأمثل لإجراء تعديلات معمارية على المباني القائمة بدون تدمير الهيكل الإنشائي.
              ...
              <p>
                كثير من مباني الإسكندرية القديمة في الأحياء المركزية كالإبراهيمية وسيدي جابر وبحري تحتاج لتوسعة فتحات الأبواب أو فتح مداخل جديدة.
                <strong>معلم قص جدار بالإسكندرية</strong> من فريقنا يدرس المقطع الإنشائي أولاً، يحدد مسار الحديد بالأجهزة المتخصصة،
                ثم ينفذ القص بدقة جراحية وبتبريد مائي كامل يمنع أي غبار.
              </p>
              <div className="not-prose space-y-4 mt-6">
                <h3 className="text-xl font-black text-slate-900">خدمات قص الخرسانة التي نقدمها في الإسكندرية:</h3>
                {[
                  ...
                  { t: 'قص السقف لعمل فتحات السلالم (دوبلكس)', d: 'دمج شقتين رأسياً في الإسكندرية؟ نقوم بقص الأسقف الخرسانية بأمان تام لعمل فتحة السلم الداخلي مع تأمين البلوك قبل فصله لمنع السقوط المفاجئ.' },
                  { t: 'قص الخرسانة لتمرير المصاعد', d: 'تأسيس بئر المصعد يتطلب قص أسقف متعددة بدقة هندسية. نملك الخبرة والمعدات اللازمة لتنفيذ هذا النوع من المشاريع في مباني الإسكندرية.' },
            ...
            {/* 2. تخريم الكور */}
            <Section id="core-alexandria" title="تخريم الخرسانة بالكور في الإسكندرية">
              <p>
                <strong>تخريم الخرسانة بالكور في الإسكندرية</strong> هو إحداث فتحات أسطوانية دقيقة في الجدران والأسقف الخرسانية باستخدام ماكينة كور دريل مزودة بأسطوانات ألماسية.
              ...
              <div className="not-prose mt-6 space-y-4">
                <h3 className="text-xl font-black text-slate-900">أبرز استخدامات تخريم الكور في الإسكندرية:</h3>
                <div className="grid gap-4 md:grid-cols-2">
                  {[
                    { icon: Flame, color: 'text-orange-500', bg: 'bg-orange-50', t: 'فتحات الغاز الطبيعي', d: 'فتحات بالأقطار المطابقة لاشتراطات شركات الغاز في الإسكندرية مع ضمان استقامة المسار.' },
                    { icon: Wind, color: 'text-sky-500', bg: 'bg-sky-50', t: 'فتحات التكييف والتهوية', d: 'فتحات بميل مضبوط للـ split وتمرير دكتات التكييف المركزي في فيلات وأبراج الإسكندرية.' },
                    ...
                    { icon: Fan, color: 'text-emerald-500', bg: 'bg-emerald-50', t: 'فتحات الشفاطات والمداخن', d: 'فتحة المدخنة ومسار الدكت بالقطر المناسب للشفاط مع ضمان الإحكام ضد رطوبة هواء الإسكندرية.' },
                  ].map(x => (
            ...
            {/* 3. مقارنة */}
            <Section id="comparison" title="قص الخرسانة الاحترافي مقابل التكسير التقليدي في الإسكندرية">
              <p>
                لا يزال بعض مقاولي الإسكندرية يلجؤون إلى <strong>التكسير بالهيلتي أو الصاروخ اليدوي</strong> لفتح الفتحات،
                وهذا قد يُشكّل خطراً حقيقياً على مباني الإسكندرية القديمة التي تعاني أصلاً من التقادم وتأثير رطوبة البحر على الخرسانة.
                اليك مقارنة موضوعية:
              </p>
            ...
            {/* 4. الشفاطات */}
            <Section id="hoods-alexandria" title="تركيب شفاطات المطابخ والحمامات بالإسكندرية">
              <p>
                نقدم خدمة <strong>تركيب شفاط المطبخ بالإسكندرية</strong> بشكل متكامل — من تخريم الفتحة بالكور بالقطر والميل الصحيحين،
              ...
              <p>
                نعلم أن رطوبة الجو الساحلي في الإسكندرية تعني أن <strong>اختيار الشفاط المناسب</strong> له أهمية خاصة.
              ...
              <div className="not-prose grid gap-4 md:grid-cols-3 mt-6">
                {[
                  ...
                  { t: 'شفاطات بفلتر كربوني', d: 'للشقق التي لا يمكن فيها عمل فتحة خارجية — الحل الأنسب لأبراج الإسكندرية عالية الطوابق.' },
                  { t: 'شفاطات حمام مركزية', d: 'تركيب شبكة دكت مركزية لطرد الرطوبة المتراكمة في الحمامات — ضرورة في مناخ الإسكندرية الرطب.' },
                ].map(x => (
            ...
            {/* 5. الواير الماسي */}
            <Section id="wire-alexandria" title="قص الخرسانة بالواير الماسي في الإسكندرية — المشاريع الكبرى">
              <p>
                <strong>قص الخرسانة بالواير الماسي (Diamond Wire Sawing) بالإسكندرية</strong> هو الحل النهائي لمشاريع البنية التحتية الكبرى
                التي تفوق قدرة المنشار التقليدي — مثل قص كباري كورنيش الإسكندرية، قواعد الأرصفة البحرية، الأساسات الضخمة، وقواعد الماكينات الصناعية في الدخيلة وبرج العرب.
              </p>
              <p>
                ...
                لا يوجد حد أقصى لسماكة الخرسانة — مما يجعله مثالياً لمشاريع الإسكندرية الكبرى.
              </p>
            ...
            <Section
              id="pricing"
              title="دليل أسعار قص وتخريم الخرسانة في الإسكندرية"
              subtitle="سياسة التسعير الشفاف — لا توجد أسعار مخفية أو مفاجآت"
            >
              <p>
                <strong>أسعار قص الخرسانة في الإسكندرية</strong> تتحدد بناءً على معايير هندسية واضحة وليس جزافاً.
              ...
              <div className="not-prose mt-6 space-y-4">
                ...
                <div className="rounded-3xl overflow-hidden border border-slate-200 bg-white shadow-sm">
                  <div className="bg-slate-900 p-5">
                    <h3 className="text-lg font-black text-sky-400">عوامل تسعير قص الخرسانة بالإسكندرية</h3>
                  </div>
                  <div className="divide-y divide-slate-100">
                    {[
                      ...
                      {
                        icon: '📍', t: 'موقع العمل داخل الإسكندرية',
                ...
                <div className="rounded-2xl bg-sky-50 border border-sky-200 p-6 flex gap-4">
                  ...
                  <div>
                    <div className="font-black text-slate-900 mb-1">خصم خاص للمقاولين وأصحاب المشاريع في الإسكندرية</div>
                    <p className="text-slate-600 text-sm leading-7">
                      نقدم تسعيراً خاصاً للمقاولين والمكاتب الهندسية وأصحاب المشاريع الكبيرة بالإسكندرية عند التعاقد على كميات
            ...
            <Section
              id="alx-buildings"
              title="تحديات مباني الإسكندرية وكيف نتعامل معها"
              subtitle="خبرة متراكمة في خصوصية البناء الساحلي المصري"
            >
              <p>
                تختلف مباني الإسكندرية عن مباني القاهرة في عدة جوانب تؤثر على طريقة تنفيذ أعمال القص والتخريم:
              </p>
              <div className="not-prose grid gap-4 md:grid-cols-2 mt-6">
                {[
                  { t: 'المباني الكلاسيكية القديمة', d: 'عمائر الإسكندرية القديمة تحتوي على خرسانة متقادمة أقل صلابة وأكثر حساسية للاهتزاز. نتعامل معها بماكينات منخفضة الدوران وتبريد مائي مكثف لضمان عدم تفتت الخرسانة المحيطة.', bg: 'bg-amber-50 border-amber-100' },
                  { t: 'الأبراج والعمارات الحديثة', d: 'الخرسانة عالية الإجهاد في أبراج الإسكندرية الحديثة تحتاج أسطوانات ألماس بجودة عالية وضغط هيدروليكي أعلى. معداتنا مُهيّأة للتعامل مع أصعب أنواع الخرسانة الحديثة.', bg: 'bg-sky-50 border-sky-100' },
                  ...
                  { t: 'الفيلات والمنازل الساحلية', d: 'المنازل القريبة من البحر في الإسكندرية تعاني أحياناً من تآكل الحديد الداخلي بفعل الرطوبة. نأخذ ذلك بعين الاعتبار عند المعاينة لتحديد النقاط الآمنة للقص والتخريم.', bg: 'bg-emerald-50 border-emerald-100' },
                ].map(x => (
            ...
            {/* 8. مراحل التنفيذ */}
            <Section id="process" title="مراحل تنفيذ العمل في الإسكندرية: من التواصل إلى التسليم">
              <div className="space-y-6 not-prose">
                {[
                  { n: '1', t: 'التواصل وتحديد المتطلبات', d: 'تتواصل معنا عبر واتساب أو الاتصال وتشرح نوع العمل المطلوب (قص أو تخريم أو تركيب)، الموقع في الإسكندرية، وطبيعة الجدار أو السقف.' },
                  { n: '2', t: 'المعاينة الميدانية المجانية', d: 'يصل فريقنا لموقعك في الإسكندرية لمعاينة الموقع بالكاشف الإلكتروني لتحديد أماكن حديد التسليح، ثم نُقدم عرض سعر نهائياً ومحدداً بدون أي رسوم مخفية.' },
            ...
            {/* 9. FAQ */}
            <Section id="faq" title="الأسئلة الشائعة عن خدمات قص وتخريم الخرسانة بالإسكندرية">
          ...
          <aside className="space-y-6 min-w-0">
            ...
            <div className="p-7 rounded-[40px] bg-sky-600 text-white shadow-xl relative overflow-hidden sticky top-20">
              ...
              <p className="text-sky-100 text-sm mb-5 leading-7">
                فريقنا في الإسكندرية يصل إليك ويُقدم عرض سعر فوري — بدون أي التزام.
              </p>
              <a href={WHATSAPP} target="_blank" rel="noopener noreferrer"
            ...
            <div className="p-7 rounded-[40px] bg-white border border-black/10 shadow-lg">
              <h3 className="font-black text-xl text-slate-900 mb-5">لماذا نحن الخيار الأول بالإسكندرية؟</h3>
          ...
          <div className="relative z-10 p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-500/20 text-sky-300 font-bold mb-5 text-sm border border-sky-500/30">
                ...
                خدمة متخصصة بالإسكندرية
              </div>
              <h2 className="text-2xl md:text-4xl font-black mb-4 leading-tight">
                جاهز لبدء مشروعك في الإسكندرية؟
              </h2>
              <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                تواصل معنا الآن للحصول على معاينة مجانية وعرض سعر فوري. فريقنا في الإسكندرية جاهز 7 أيام أسبوعياً.
              </p>
